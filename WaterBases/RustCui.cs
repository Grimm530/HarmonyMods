...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        public static bool AddUi(BasePlayer player, string json)
        {
            if (player?.net != null)
            {
                // Clients only forward ConsoleGen commands. Rewrite WaterBases CUI button commands
                // to cui.endtest WB … so Patches.Cui_Endtest_Patch can route them.
        ...
        /// never leave the client. Bridge WaterBases commands through cui.endtest ST.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            ...
            var cmds = WaterBasesHarmony.WaterBasesMod.Instance?.UiConsoleCommands;
            ...
            for (int i = 0; i < cmds.Count; i++)
            {
                ...
                string bridgeArgs = "\"command\":\"cui.endtest WB " + cmd + " ";
                string bridgeAlone = "\"command\":\"cui.endtest WB " + cmd + "\"";
