...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        public static bool AddUi(BasePlayer player, string json)
        {
            if (player?.net != null)
            {
                // Clients only forward ConsoleGen commands. Rewrite UpLifted CUI button commands
                // to cui.endtest UPLIFTED … so Patches.Cui_Endtest_Patch can route them.
        ...
        /// never leave the client. Bridge UpLifted commands through cui.endtest ST.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            ...
            var cmds = UpLiftedHarmony.UpLiftedMod.Instance?.UiConsoleCommands;
            ...
            for (int i = 0; i < cmds.Count; i++)
            {
                ...
                string bridgeArgs = "\"command\":\"cui.endtest UPLIFTED " + cmd + " ";
                string bridgeAlone = "\"command\":\"cui.endtest UPLIFTED " + cmd + "\"";
