...
None. Mod has no console command surface. (A separate Harmony mod `StackManagerCommands.cs` may provide `stackmanager.listweapons`; not part of this Harmony mod.)
