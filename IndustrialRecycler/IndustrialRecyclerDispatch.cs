...
namespace Oxide.Plugins
{
    ...
    {
        internal static void SetInstance(IndustrialRecycler inst) => _instance = inst;
        internal static void ClearInstance() => _instance = null;
        internal static IndustrialRecycler GetModInstance() => _instance;
        ...
        public void CallInit()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[IndustrialRecycler] Init failed: " + ex.Message); }
            try { HarmonyLoadDefaultMessages(); }
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[IndustrialRecycler] LoadDefaultMessages failed: " + ex.Message); }
        }
        ...
        public void CallLoaded()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[IndustrialRecycler] Loaded failed: " + ex.Message); }
        }
        ...
        public void CallOnServerInitialized()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogError("[IndustrialRecycler] OnServerInitialized failed: " + ex); }
        }
        ...
        public void CallUnload()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[IndustrialRecycler] Unload failed: " + ex.Message); }
        }
        ...
        static System.Reflection.MethodInfo FindHook(IndustrialRecycler inst, string hook, object[] args)
        {
        ...
        static T CallHook<T>(string hook, params object[] args)
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[IndustrialRecycler] " + hook + ": " + (ex.InnerException ?? ex).Message); }
            return default;
        }
        ...
        static object CallHookObj(string hook, params object[] args)
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[IndustrialRecycler] " + hook + ": " + (ex.InnerException ?? ex).Message); return null; }
        }
        ...
        public static object Dispatch_OnEntityKill(Recycler recycler)
            => CallHookObj("OnEntityKill", recycler);
        public static void Dispatch_OnLootEntity(BasePlayer player, Recycler recycler)
            => CallHookVoid("OnLootEntity", player, recycler);
        public static void Dispatch_OnLootEntityEnd(BasePlayer player, Recycler recycler)
            => CallHookVoid("OnLootEntityEnd", player, recycler);
