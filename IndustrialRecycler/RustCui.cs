...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        public static bool AddUi(BasePlayer player, string json)
        {
            if (player?.net != null)
            {
                // Clients only forward ConsoleGen commands. Rewrite IndustrialRecycler CUI button commands
                // to cui.endtest INDUSTRIALRECYCLER … so Patches.Cui_Endtest_Patch can route them.
        ...
        /// never leave the client. Bridge IndustrialRecycler commands through cui.endtest ST.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            ...
            var cmds = IndustrialRecyclerHarmony.IndustrialRecyclerMod.Instance?.UiConsoleCommands;
            ...
            for (int i = 0; i < cmds.Count; i++)
            {
                ...
                string bridgeArgs = "\"command\":\"cui.endtest INDUSTRIALRECYCLER " + cmd + " ";
                string bridgeAlone = "\"command\":\"cui.endtest INDUSTRIALRECYCLER " + cmd + "\"";
        ...
        {
            if (player?.net == null || CommunityEntity.ServerInstance == null)
                return false;
