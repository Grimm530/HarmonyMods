...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        public static bool AddUi(BasePlayer player, string json)
        {
            if (player?.net != null)
            {
                // Clients only forward ConsoleGen commands. Rewrite Cooking CUI button commands
                // to cui.endtest COOKING … so Patches.Cui_Endtest_Patch can route them.
        ...
        /// never leave the client. Bridge Cooking commands through cui.endtest COOKING.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            ...
            var cmds = CookingHarmony.CookingMod.Instance?.UiConsoleCommands;
            ...
            for (int i = 0; i < cmds.Count; i++)
            {
                ...
                string bridgeArgs = "\"command\":\"cui.endtest COOKING " + cmd + " ";
                string bridgeAlone = "\"command\":\"cui.endtest COOKING " + cmd + "\"";
