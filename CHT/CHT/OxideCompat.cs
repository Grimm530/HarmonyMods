// Oxide -> Harmony compatibility shims for the ported CustomHelicopterTiers plugin.
...
namespace Oxide.Core
{
    ...
    public static class Interface
    {
        ...
        /// <summary>
        /// No Oxide hook bus in Harmony. Returns null (no plugin cancels/handles). Core logic must
    ...
    public class OxideMod
    {
        ...
        /// <summary>
        /// Oxide-style data root. Plugin paths like CustomHelicopterTiers/Images resolve under HarmonyData/.
        /// </summary>
...
namespace Oxide.Plugins
{
    ...
    }    public abstract class RustPlugin
    {
        ...
        // Invoked by CHTMod to drive the Oxide-style lifecycle.
