...
namespace Convoy
{
    /// <summary>Full plugin config matching original plugin Convoy Convoy.json (English keys). Used for pathfinding + vehicle spawn.</summary>
    ...
    public class ConvoyNotifyConfig
    {
        ...
        public object GameTipConfig { get; set; }
    }
    ...
    public class ConvoySupportedPluginsConfig
    {
        ...
        public ConvoyPveModeConfig PveMode { get; set; }
