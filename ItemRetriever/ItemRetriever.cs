...
namespace ItemRetrieverHarmony
{
    ...
    public class ItemRetriever : ItemRetrieverPluginBase
    {
        ...
        internal object OnInventoryItemsCount(PlayerInventory inventory, int itemId)
        {
        ...
        internal object OnInventoryItemsTake(PlayerInventory inventory, List<Item> collect, int itemId, int amount)
        {
            var itemQuery = new ItemIdQuery(itemId);
            return ObjectCache.Get(TakePlayerItems(inventory.baseEntity, ref itemQuery, amount, collect, includePlayerWearables: true));
        }

        internal object OnInventoryItemsFind(PlayerInventory inventory, int itemId, List<Item> collect)
        {
            var itemQuery = new ItemIdQuery(itemId);
        ...
        internal object OnInventoryItemFind(PlayerInventory inventory, int itemId)
        {
            var itemQuery = new ItemIdQuery(itemId);
        ...
        internal object OnInventoryAmmoFind(PlayerInventory inventory, List<Item> collect, AmmoTypes ammoType)
        {
            FindPlayerAmmo(inventory.baseEntity, ammoType, collect);
            return False;
        }

        internal Item OnInventoryAmmoItemFind(PlayerInventory inventory, ItemDefinition itemDefinition)
        {
        ...
        internal Item OnInventoryAmmoItemFind(PlayerInventory inventory, AmmoTypes ammoType)
        {
            _reusableItemList.Clear();
        ...
        internal object OnIngredientsCollect(ItemCrafter itemCrafter, ItemBlueprint blueprint, ItemCraftTask task, int amount, BasePlayer player)
        {
        ...
        internal object CanCraft(ItemCrafter itemCrafter, ItemBlueprint blueprint, int amount, bool free)
        {
