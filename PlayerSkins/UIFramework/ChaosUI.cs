...
public class ChaosUI
{
	...
	public static void Show(BasePlayer player, BaseContainer baseContainer, bool recycle = true)
	{
		...
		// Clients only forward ConsoleGen commands; bridge playerskins.callback through cui.endtest PLAYERSKINS.
		arg = arg.Replace("\"command\":\"playerskins.callback ", "\"command\":\"cui.endtest PLAYERSKINS playerskins.callback ");
		arg = arg.Replace("\"command\": \"playerskins.callback ", "\"command\": \"cui.endtest PLAYERSKINS playerskins.callback ");
