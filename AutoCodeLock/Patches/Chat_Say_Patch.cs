...
{
    /// <summary>
    /// Route /codelock through ChatSayBridge so DynamicCupShare / RemoverTool / other
    ...
    internal static class ChatCommandRouter
    {
        internal static bool TryHandle(ConsoleSystem.Arg arg)
        {
            ...
            {
                Debug.LogWarning("[AutoCodeLock] ChatSayBridge: " + ex.Message);
            }
    ...
    internal static class Chat_Say_Patch
    {
        ...
        private static bool Prefix(ConsoleSystem.Arg arg)
        {
            ...
            {
                Debug.LogWarning("[AutoCodeLock] Chat.say: " + ex.Message);
            }
            return true;
        }
    }
    ...
    internal static class Chat_LocalSay_Patch
    {
        ...
        private static bool Prefix(ConsoleSystem.Arg arg)
        {
            ...
            {
                Debug.LogWarning("[AutoCodeLock] Chat.localsay: " + ex.Message);
            }
            return true;
        }
    }
