...
public class ChaosUI
{
	...
	public static void Show(BasePlayer player, BaseContainer baseContainer, bool recycle = true)
	{
		...
		// Clients only forward ConsoleGen commands; bridge autocodelock.callback through cui.endtest AUTOCODELOCK.
		arg = arg.Replace("\"command\":\"autocodelock.callback ", "\"command\":\"cui.endtest AUTOCODELOCK autocodelock.callback ");
		arg = arg.Replace("\"command\": \"autocodelock.callback ", "\"command\": \"cui.endtest AUTOCODELOCK autocodelock.callback ");
