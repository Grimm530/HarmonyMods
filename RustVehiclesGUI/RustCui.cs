...
namespace Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        /// <summary>
        /// The client only forwards ConsoleGen commands, so the plugin's own vgui.* button commands never
        /// reach the server. Rewrite them to "cui.endtest VGUI vgui.… " markers that
        /// RustVehiclesGUIHarmony.Patches.Cui_Endtest_Patch routes back into the console handlers.
        /// </summary>
