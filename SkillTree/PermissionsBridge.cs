 ...
 * Adapted from AdminMenu/PermissionsBridge.cs — namespace changed to SkillTreeHarmony,
 * log tag changed to [SkillTree].  Same reflection API to PermissionsHarmony.PermissionsMod.
 */
using System;
...
namespace SkillTreeHarmony
{
    ...
    public static class PermissionsBridge
    {
        ...
        public static void RegisterReadyCallback(Action callback)
        {
            ...
            {
                Debug.LogWarning("[SkillTree] RegisterReadyCallback: " + ex.Message);
            }
            ...
            {
                Debug.LogWarning("[SkillTree] RegisterReadyCallback fallback: " + ex.Message);
            }
        }
        ...
        private static void EnsureBound()
        {
            ...
            try
            {
                ...
                {
                    _loggedLink = true;
                    Debug.Log("[SkillTree] Linked to Permissions Harmony mod.");
                }
                else
                    Debug.Log($"[SkillTree] Re-linked to Permissions Harmony mod (gen={gen}).");
            }
            catch (Exception ex)
            {
                ClearBind();
                Debug.LogWarning("[SkillTree] PermissionsBridge bind failed: " + ex.Message);
            }
        }
        ...
        private static void BindService()
        {
            ...
            {
                Debug.LogWarning("[SkillTree] Permissions Service bind: " + ex.Message);
            }
        }
