...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        /// chat.say / chat.localsay buttons are real client commands and are left untouched.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            if (string.IsNullOrEmpty(json) || json.IndexOf("\"command\":\"pnpc", StringComparison.Ordinal) < 0)
                return json;

            json = json.Replace("\"command\":\"pnpchelper.", "\"command\":\"cui.endtest PNPCHELPER pnpchelper.");
            json = json.Replace("\"command\":\"pnpc", "\"command\":\"cui.endtest PNPC pnpc");
            return json;
        }
