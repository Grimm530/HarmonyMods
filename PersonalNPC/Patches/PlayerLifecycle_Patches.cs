...
namespace PersonalNPCHarmony.Patches
{
    ...
    /// <summary>Harmony OnPlayerDisconnected -> BasePlayer.OnDisconnected postfix (core + helper).</summary>
    ...
    /// <summary>
    /// Harmony OnPlayerDeath -> BasePlayer.Die prefix. PersonalNPC returns false for its own bots so
