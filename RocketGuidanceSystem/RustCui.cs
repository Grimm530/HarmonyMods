...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        public static bool AddUi(BasePlayer player, string json)
        {
            if (player?.net != null)
            {
                // Clients only forward ConsoleGen commands. Rewrite RocketGuidanceSystem CUI button commands
                // to cui.endtest RGS … so Patches.Cui_Endtest_Patch can route them.
        ...
        /// never leave the client. Bridge RocketGuidanceSystem commands through cui.endtest ST.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            ...
            var cmds = RocketGuidanceSystemHarmony.RocketGuidanceSystemMod.Instance?.UiConsoleCommands;
            ...
            for (int i = 0; i < cmds.Count; i++)
            {
                ...
                string bridgeArgs = "\"command\":\"cui.endtest RGS " + cmd + " ";
                string bridgeAlone = "\"command\":\"cui.endtest RGS " + cmd + "\"";
