...
{
    public partial class RocketGuidanceSystem
    {
        internal static void SetInstance(RocketGuidanceSystem inst) => Instance = inst;
        internal static void ClearInstance() => Instance = null;
        internal static RocketGuidanceSystem GetModInstance() => Instance;
        ...
        public void CallInit()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[RocketGuidanceSystem] Init failed: " + ex.Message); }
            try { HarmonyLoadDefaultMessages(); }
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[RocketGuidanceSystem] LoadDefaultMessages failed: " + ex.Message); }
        }
        ...
        public void CallLoaded()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[RocketGuidanceSystem] Loaded failed: " + ex.Message); }
        }
        ...
        public void CallOnServerInitialized()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogError("[RocketGuidanceSystem] OnServerInitialized failed: " + ex); }
        }
        ...
        public void CallUnload()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[RocketGuidanceSystem] Unload failed: " + ex.Message); }
        }
        ...
        static System.Reflection.MethodInfo FindHook(RocketGuidanceSystem inst, string hook, object[] args)
        {
        ...
        static T CallHook<T>(string hook, params object[] args)
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[RocketGuidanceSystem] " + hook + ": " + (ex.InnerException ?? ex).Message); }
            return default;
        }
        ...
        static object CallHookObj(string hook, params object[] args)
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[RocketGuidanceSystem] " + hook + ": " + (ex.InnerException ?? ex).Message); return null; }
        }
