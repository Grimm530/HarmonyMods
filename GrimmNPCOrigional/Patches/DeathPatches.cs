...
namespace GrimmNPC.Patches
{
    ...
    public class NPCPlayer_CreateCorpse_Patch
    {
        static void Prefix(NPCPlayer __instance)
        {
            ...
            // Trigger bomber explosion on death (like NpcSpawn and DefendableHomes)
            if (npc.displayName == "Bomber")
            {
                ...
                // DefendableHomes listens to OnCorpsePopulate, but we call OnBomberExplosion directly
