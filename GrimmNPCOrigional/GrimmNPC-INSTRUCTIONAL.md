...
- **Special Weapons**: GrimmNPC's `SpecialWeaponsHandler` handles all special weapon attacks (rockets, grenades, flamethrowers, bows, etc.) via `TryHandleCombatAttack()` called from ThinkPatches. BetterNpc does NOT interfere with this.
