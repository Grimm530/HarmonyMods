...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        public static bool AddUi(BasePlayer player, string json)
        {
            if (player?.net != null)
            {
                // Clients only forward ConsoleGen commands. Rewrite Quest CUI button commands
                // to cui.endtest QUEST … so Patches.Cui_Endtest_Patch can route them.
        ...
        /// never leave the client. Bridge Quest commands through cui.endtest QUEST.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            ...
            var cmds = QuestHarmony.QuestMod.Instance?.UiConsoleCommands;
            ...
            for (int i = 0; i < cmds.Count; i++)
            {
                ...
                string bridgeArgs = "\"command\":\"cui.endtest QUEST " + cmd + " ";
                string bridgeAlone = "\"command\":\"cui.endtest QUEST " + cmd + "\"";
