...
namespace KitsHarmony
{
    ...
    public class Kits : KitsPluginBase
    {
        ...
        private const string
            ...
            PERM_DLC = "Kits.dlc",
            PERM_BYPASS_COOLDOWN = "Kits.bypasscooldown",
            PERM_BYPASS_LIMIT = "Kits.bypasslimit",
            Layer = "UI.Kits",
        ...
        private readonly Dictionary<int, EconomyConf> _additionalEconomics = new();
        ...
        private class Configuration
        {
            ...
            [JsonProperty(PropertyName = LangRu ? "Запретить сохранение дата-файлов для игроков?" : "Disable saving data files for players?")]
            public bool DisableDataFiles = false;
            ...
            {
                [JsonProperty(PropertyName = LangRu ? "Настройки получения" : "Receive Settings")]
                public DiscordLogSettings Receive = new()
                {
                    Enabled = false,
                    Webhook = "",
                    Color = 3066993, // Green
                    ...
                    FooterText = "{username} claimed kit {kitname}"
                };

                [JsonProperty(PropertyName = LangRu ? "Настройки выдачи" : "Give Settings")]
                public DiscordLogSettings Give = new()
                {
                    Enabled = false,
                    Webhook = "",
                    Color = 15158332, // Red
                    Title = "Kit Given",
                    FooterIconUrl = string.Empty,
                    FooterText = "{username} given kit {kitname}"
                };
                ...
                public class DiscordLogSettings
                {
                    ...
                    [JsonProperty(PropertyName = LangRu ? "URL иконки футера" : "Footer icon URL")]
                    public string FooterIconUrl;

                    [JsonProperty(PropertyName =
                        LangRu
                            ? "Текст футера. Переменные: {username}, {steamid}, {kitname}"
                            : "Footer text. Variables: {username}, {steamid}, {kitname}")]
        ...
        private class EconomyConf
        {
            ...
            [JsonProperty(PropertyName = LangRu ? "Формат цены" : "Price Format")]
            ...
            {
                return !string.IsNullOrEmpty(PriceFormat) ? PriceFormat : "{0}";
            }
        ...
        private class UserInterface
        {
            ...
            [JsonProperty(PropertyName = LangRu ? "Стиль" : "Style")] [JsonConverter(typeof(StringEnumConverter))]
            public InterfaceStyle Style;

            [JsonProperty(PropertyName = LangRu ? "Показать категории" : "Show Categories")]
            public bool ShowCategories;

            [JsonProperty(PropertyName = LangRu ? "Показать категорию ALL" : "Show ALL Category")]
            public bool ShowCategoryAll = true;
            ...
            [JsonProperty(PropertyName = LangRu ? "Использовать скролл" : "Use Scroll")]
            public bool UseScroll;

            [JsonProperty(PropertyName = LangRu ? "Настройки скролла китов" : "Kit Scroll Settings")]
            public ScrollViewUI KitScrollSettings = new();
            ...
            [JsonProperty(PropertyName = LangRu ? "Настройки модального окна ошибки" : "Error Modal Settings")]
            public ErrorModalUI ErrorModal = new();
            ...
            {
                [JsonProperty(PropertyName = "Size")] public float Size = 40f;
            ...
            public class ErrorModalUI
            {
                [JsonProperty(PropertyName = "Background Overlay")]
                public ImageSettings Background = new()
                {
                    AnchorMin = "0 0",
                    AnchorMax = "1 1",
                    Color = new IColor("#161617", 80),
                    CursorEnabled = true
                };

                [JsonProperty(PropertyName = "Main Panel")]
                public ImageSettings MainPanel = new()
                {
                    AnchorMin = "0.5 0.5",
                    AnchorMax = "0.5 0.5",
                ...
                public TextSettings Message = new()
                {
                    AnchorMin = "0 1",
                    AnchorMax = "1 1",
                    OffsetMin = "0 -175",
                ...
                [JsonProperty(PropertyName = "Close Button")]
                public ButtonSettings CloseButton = new()
                {
                    AnchorMin = "0 0",
                    AnchorMax = "1 0",
                    OffsetMin = "0 0",
            ...
            public static UserInterface GenerateFullscreenTemplateOldStyle()
            {
                return new UserInterface
                {
                    ...
                    Strings = 2,
                    UseScroll = false,
                    KitScrollSettings = new ScrollViewUI
                    {
                    ...
                    KitAmountCooldown = new ButtonSettings
                    {
                        AnchorMin = "0 1",
                        AnchorMax = "1 1",
                        OffsetMin = "0 -120",
                    ...
                    ContentPanel = new KitsPanelContentUI
                    {
                        ...
                        CheckboxShowAllKits = new CheckBoxSettings
                        {
                            ...
                            CheckboxColor = new IColor("#4B68FF"),
                            CheckboxSize = 2f,
                            Title = new TextSettings
                            {
                                AnchorMin = "1 0",
                    ...
                    ColorOne = new IColor("#161617"),
                    ColorTwo = new IColor("#0E0E10"),
                    ColorThree = new IColor("#4B68FF"),
                    ColorFour = new IColor("#303030"),
                    ColorFive = new IColor("#0E0E10", 98),
                    ColorRed = new IColor("#FF4B4B"),
                    ColorWhite = new IColor("#FFFFFF"),
                    ColorBackground = new IColor("#0E0E10")
                };
            }
            ...
            public static UserInterface GenerateFullscreenTemplateRust()
            {
                return new UserInterface
                {
                    ...
                    Categories = new KitsCategoryUI(),
                    ColorOne = new IColor("#E2DBD3"),
                    ColorTwo = new IColor("#D74933"),
            ...
            public static UserInterface GenerateMenuTemplateRustV4()
            {
                return new UserInterface
                {
                    Style = InterfaceStyle.NewRust,
                    ...
                    YIndent = -4f,
                    ShowCategories = false,
                    KitAvailable = new InterfacePosition { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0", OffsetMax = "0 0" },
                    KitAmount = new KitAmountSettings { Width = 140f, AnchorMin = "0.5 0", AnchorMax = "0.5 0", OffsetMin = "0", OffsetMax = "4" },
                    KitCooldown = new ButtonSettings { AnchorMin = "0 0.5", AnchorMax = "1 0.5", OffsetMin = "0 -10", OffsetMax = "0 20" },
                    KitSale = new InterfacePosition { AnchorMin = "0 0.5", AnchorMax = "1 0.5", OffsetMin = "0 -10", OffsetMax = "0 20" },
                    KitAmountCooldown = new ButtonSettings { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 4", OffsetMax = "0 0" },
                    NoPermission = new TextSettings { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0", OffsetMax = "0 0" },
                    CloseAfterReceive = true,
                    Logo = new LogoConf { Enabled = false, Image = string.Empty, AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "10 -20", OffsetMax = "50 20" },
                    MainBackground = new ImageSettings { Sprite = string.Empty, Material = string.Empty, Image = string.Empty, Color = new IColor("#000000", 0f), CursorEnabled = false, KeyboardEnabled = false, AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0", OffsetMax = "0 0" },
                    MainPanel = new ImageSettings { Sprite = string.Empty, Material = string.Empty, Image = string.Empty, Color = new IColor("#000000", 0f), CursorEnabled = false, KeyboardEnabled = false, AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0", OffsetMax = "0 0" },
                    HeaderPanel = new KitsPanelHeaderUI
                    {
                        Background = new ImageSettings { Sprite = string.Empty, Material = string.Empty, Image = string.Empty, Color = IColor.CreateTransparent(), CursorEnabled = false, KeyboardEnabled = false, AnchorMin = "0 1", AnchorMax = "1 1", OffsetMin = "40 -50", OffsetMax = "-40 0" },
                        Title = new TextSettings { FontSize = 0, IsBold = true, Align = TextAnchor.UpperLeft, Color = IColor.CreateTransparent(), AnchorMin = "0 1", AnchorMax = "1 1", OffsetMin = "0 -50", OffsetMax = "-5 0" },
                        ShowLine = false,
                        Line = new ImageSettings { Sprite = string.Empty, Material = string.Empty, Image = string.Empty, Color = IColor.CreateTransparent(), CursorEnabled = false, KeyboardEnabled = false, AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0", OffsetMax = "0 0" },
                        ButtonClose = new ButtonSettings { ButtonColor = IColor.CreateWhite(), Sprite = string.Empty, Material = string.Empty, Image = string.Empty, ImageColor = IColor.CreateWhite(), UseCustomPositionImage = false, ImagePosition = InterfacePosition.CreateFullStretch(), FontSize = 12, IsBold = false, Align = TextAnchor.UpperLeft, Color = IColor.CreateWhite(), AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0", OffsetMax = "0 0" }
                    },
                    ContentPanel = new KitsPanelContentUI
                    {
                        Background = new ImageSettings { Sprite = string.Empty, Material = string.Empty, Image = string.Empty, Color = IColor.CreateTransparent(), CursorEnabled = false, KeyboardEnabled = false, AnchorMin = "0 0.5", AnchorMax = "1 0.5", OffsetMin = "40 -250", OffsetMax = "-40 220" },
                        ButtonBack = new ButtonSettings { ButtonColor = new IColor("#222222"), Sprite = string.Empty, Material = string.Empty, Image = string.Empty, ImageColor = IColor.CreateWhite(), UseCustomPositionImage = false, ImagePosition = InterfacePosition.CreateFullStretch(), FontSize = 12, IsBold = true, Align = TextAnchor.MiddleCenter, Color = new IColor("#FFFFFF", 60), AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-65 0", OffsetMax = "-35 20" },
                        ButtonNext = new ButtonSettings { ButtonColor = new IColor("#222222"), Sprite = string.Empty, Material = string.Empty, Image = string.Empty, ImageColor = IColor.CreateWhite(), UseCustomPositionImage = false, ImagePosition = InterfacePosition.CreateFullStretch(), FontSize = 12, IsBold = true, Align = TextAnchor.MiddleCenter, Color = new IColor("#FFFFFF", 80), AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-30 0", OffsetMax = "0 20" },
                        ButtonCreateKit = new ButtonSettings { ButtonColor = new IColor("#222222"), Sprite = string.Empty, Material = string.Empty, Image = string.Empty, ImageColor = IColor.CreateWhite(), UseCustomPositionImage = false, ImagePosition = InterfacePosition.CreateFullStretch(), FontSize = 12, IsBold = true, Align = TextAnchor.MiddleCenter, Color = new IColor("#FFFFFF", 60), AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-160 0", OffsetMax = "-70 20" },
                        CheckboxShowAllKits = new CheckBoxSettings
                        {
                            Background = new ImageSettings { Sprite = string.Empty, Material = string.Empty, Image = string.Empty, Color = IColor.CreateTransparent(), CursorEnabled = false, KeyboardEnabled = false, AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "0 4", OffsetMax = "22 16" },
                            CheckboxButton = new ButtonSettings { ButtonColor = IColor.CreateTransparent(), Sprite = string.Empty, Material = string.Empty, Image = string.Empty, ImageColor = IColor.CreateWhite(), UseCustomPositionImage = false, ImagePosition = InterfacePosition.CreateFullStretch(), FontSize = 10, IsBold = true, Align = TextAnchor.MiddleCenter, Color = IColor.CreateWhite(), AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "5 -7", OffsetMax = "19 7" },
                            CheckboxSize = 3f, CheckboxColor = new IColor("#38393F"),
                            Title = new TextSettings { FontSize = 10, IsBold = true, Align = TextAnchor.MiddleLeft, Color = IColor.CreateWhite(), AnchorMin = "1 0", AnchorMax = "1 1", OffsetMin = "4 -4", OffsetMax = "104 4" }
                        }
                    },
                    KitPanel = new KitsPanelKitUI
                    {
                        Background = new ImageSettings { Sprite = string.Empty, Material = string.Empty, Image = string.Empty, Color = new IColor("#222222", 80f), CursorEnabled = false, KeyboardEnabled = false, AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0", OffsetMax = "0 0" },
                        ShowName = true,
                        KitName = new TextSettings { FontSize = 18, IsBold = true, Align = TextAnchor.MiddleCenter, Color = new IColor("#E2DBD3"), AnchorMin = "0 1", AnchorMax = "1 1", OffsetMin = "10 -35", OffsetMax = "-10 -5" },
                        ShowNumber = true,
                        KitNumber = new TextSettings { FontSize = 60, IsBold = true, Align = TextAnchor.MiddleCenter, Color = new IColor("#E2DBD3", 20f), AnchorMin = "0.5 1", AnchorMax = "0.5 1", OffsetMin = "-60 -155", OffsetMax = "60 -35" },
                        KitImage = new InterfacePosition { AnchorMin = "0.5 1", AnchorMax = "0.5 1", OffsetMin = "-60 -155", OffsetMax = "60 -35" },
                        KitButtonTake = new ButtonSettings { ButtonColor = new IColor("#D74933"), Sprite = "assets/content/ui/UI.Background.Tile.psd", Material = "assets/content/ui/namefontmaterial.mat", Image = string.Empty, ImageColor = IColor.CreateWhite(), UseCustomPositionImage = false, ImagePosition = InterfacePosition.CreateFullStretch(), FontSize = 13, IsBold = true, Align = TextAnchor.MiddleCenter, Color = new IColor("#E2DBD3"), AnchorMin = "0.5 0", AnchorMax = "0.5 0", OffsetMin = "-70 10", OffsetMax = "70 38" },
                        KitButtonTakeWhenShowInfo = new ButtonSettings { ButtonColor = new IColor("#5D7238"), Sprite = "assets/content/ui/UI.Background.Tile.psd", Material = "assets/content/ui/namefontmaterial.mat", Image = string.Empty, ImageColor = IColor.CreateWhite(), UseCustomPositionImage = false, ImagePosition = InterfacePosition.CreateFullStretch(), FontSize = 13, IsBold = true, Align = TextAnchor.MiddleCenter, Color = new IColor("#E2DBD3"), AnchorMin = "0.5 0", AnchorMax = "0.5 0", OffsetMin = "-70 10", OffsetMax = "40 38" },
                        KitButtonInfo = new ButtonSettings { ButtonColor = new IColor("#222222"), Sprite = "assets/content/ui/UI.Background.Tile.psd", Material = "assets/content/ui/namefontmaterial.mat", Image = string.Empty, ImageColor = IColor.CreateWhite(), UseCustomPositionImage = false, ImagePosition = InterfacePosition.CreateFullStretch(), FontSize = 13, IsBold = true, Align = TextAnchor.MiddleCenter, Color = new IColor("#E2DBD3"), AnchorMin = "0 0", AnchorMax = "1 0", OffsetMin = "125 10", OffsetMax = "-10 38" },
                        ShowLine = false,
                        KitLine = new InterfacePosition { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0", OffsetMax = "0 0" },
                        DisplayKitContents = false,
                        Contents = new ContentsSettings()
                    },
                    Categories = new KitsCategoryUI(),
                    ColorOne = new IColor("#E2DBD3"),
                    ColorTwo = new IColor("#AA4735"),
                    ColorThree = new IColor("#222222"),
                    ColorFour = new IColor("#38393F", 50f),
                    ColorFive = new IColor("#E2DBD3", 20f),
                    ColorRed = new IColor("#FF4B4B"),
                    ColorWhite = new IColor("#FFFFFF"),
                    ColorBackground = new IColor("#000000", 0f)
                };
            }

            public static UserInterface GenerateMenuTemplateRustWithCategoriesV4()
            {
                return new UserInterface
                {
                    Style = InterfaceStyle.NewRust,
                    ...
                    Categories = new KitsCategoryUI
                    {
                        Background = InterfacePosition.CreatePosition("0 1", "1 1", "40 -50", "-40 -20"),
                        Height = 32f,
                        Width = 120f,
                        Margin = 2f,
                        CategoriesScrollMinWidth = 1200f,
                        ActiveCategory = new ButtonSettings { ButtonColor = new IColor("#5D7238"), Sprite = "assets/content/ui/UI.Background.Tile.psd", Material = "assets/content/ui/namefontmaterial.mat", Image = string.Empty, ImageColor = IColor.CreateWhite(), UseCustomPositionImage = false, ImagePosition = InterfacePosition.CreateFullStretch(), FontSize = 14, IsBold = true, Align = TextAnchor.MiddleCenter, Color = new IColor("#E2DBD3"), AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0", OffsetMax = "0 0" },
                        InactiveCategory = new ButtonSettings { ButtonColor = new IColor("#222222"), Sprite = "assets/content/ui/UI.Background.Tile.psd", Material = "assets/content/ui/namefontmaterial.mat", Image = string.Empty, ImageColor = IColor.CreateWhite(), UseCustomPositionImage = false, ImagePosition = InterfacePosition.CreateFullStretch(), FontSize = 14, IsBold = true, Align = TextAnchor.MiddleCenter, Color = new IColor("#E2DBD3", 90f), AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0", OffsetMax = "0 0" }
                    },
                    ColorOne = new IColor("#E2DBD3"),
                    ColorTwo = new IColor("#AA4735"),
                    ColorThree = new IColor("#222222"),
            ...
            public static UserInterface GenerateMenuTemplateRustWithContentsV4()
            {
                return new UserInterface
                {
                    Style = InterfaceStyle.NewRust,
                    ...
                    ContentPanel = new KitsPanelContentUI
                    {
                        ...
                        {
                            AnchorMin = "0 0.5", AnchorMax = "1 0.5",
                            OffsetMin = "40 -250", OffsetMax = "-40 230",
                            Color = IColor.CreateTransparent()
                        },
                        ButtonBack = new ButtonSettings
                        {
                            ...
                            IsBold = true,
                            FontSize = 12,
                            Color = new IColor("#FFFFFF", 60),
                            ButtonColor = new IColor("#222222")
                        },
                        ButtonNext = new ButtonSettings
                        {
                            AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-30 6", OffsetMax = "0 36",
            ...
            public static UserInterface GenerateMenuTemplateRustWithContentsAndCategoriesV4()
            {
                return new UserInterface
                {
                    Style = InterfaceStyle.NewRust,
                    ...
                    ContentPanel = new KitsPanelContentUI
                    {
                        ...
                        {
                            AnchorMin = "0 0.5", AnchorMax = "1 0.5",
                            OffsetMin = "40 -260", OffsetMax = "-40 210",
                            Color = IColor.CreateTransparent()
                        },
                        ButtonBack = new ButtonSettings
                        {
        ...
        private class KitAmountSettings : InterfacePosition
        {
            ...
            [JsonProperty(PropertyName = LangRu ? "Цвет полоски" : "Bar Color")]
            public IColor BarColor = new IColor("#71B8ED", 10);

            [JsonProperty(PropertyName = LangRu ? "Цвет использованной полоски" : "Used Bar Color")]
            public IColor UsedBarColor = new IColor("#71B8ED", 70);

            [JsonProperty(PropertyName = LangRu ? "Материал полоски" : "Bar Material")]
            public string BarMaterial = "assets/content/ui/namefontmaterial.mat";

            public float GetOffsetYMin()
            {
                var parts = OffsetMin.Split(' ');
                return float.TryParse(parts.Length > 1 ? parts[1] : parts[0], NumberStyles.Float, CultureInfo.InvariantCulture, out var val) ? val : 0;
            }

            public float GetOffsetYMax()
            {
                var parts = OffsetMax.Split(' ');
                return float.TryParse(parts.Length > 1 ? parts[1] : parts[0], NumberStyles.Float, CultureInfo.InvariantCulture, out var val) ? val : 0;
            }
        }
        ...
        protected override void LoadConfig()
        {
            ...
            try
            {
                ...
                SaveConfig();
                Puts($"Config loaded from HarmonyConfig/Kits.json (commands={string.Join(",", _config.Commands ?? Array.Empty<string>())}, autoKits={_config.AutoKits?.Count ?? 0})");
            }
            catch (Exception ex)
            {
                PrintError("Your configuration file contains an error. Using default configuration values. Message: " +
                           ex.Message);
                LoadDefaultConfig();
            }
        ...
        private void UpdateConfigValues()
        {
            ...
            if (_config.Version != default)
            {
                ...
                if (_config.Version < new VersionNumber(2, 1, 4))
                {
                    ...
                    var width = Convert.ToSingle(Config.Get(LangRu ? "Интерфейс" : "Interface",
                        LangRu ? "Ширина" : "Width"));
                    var height = Convert.ToSingle(Config.Get(LangRu ? "Интерфейс" : "Interface",
                        LangRu ? "Высота" : "Height"));
                    if (width > 0 || height > 0)
                    {
                        var color = JsonConvert.DeserializeObject<IColor>(JsonConvert.SerializeObject(
                            Config.Get(LangRu ? "Интерфейс" : "Interface", LangRu ? "Цвет фона" : "Background Color")));
                ...
                if (_config.Version < new VersionNumber(2, 3, 5))
                {
                    // Migrate KitCooldown from InterfacePosition to ButtonSettings
                    MigrateToButtonSettings(_config.UI);
                    MigrateToButtonSettings(_config.MenuUI);
                }
            }
        ...
        private void MigrateToButtonSettings(UserInterface ui)
        {
            ui.KitCooldown ??= new ButtonSettings();
            ui.KitAmountCooldown ??= new ButtonSettings();
            ui.NoPermission ??= new TextSettings();

            if (ui.KitCooldown != null)
            {
                ui.KitCooldown.ButtonColor = new IColor("#71B8ED", 10);
                ui.KitCooldown.Material = "assets/content/ui/namefontmaterial.mat";
                ui.KitCooldown.FontSize = 14;
                ui.KitCooldown.IsBold = true;
                ui.KitCooldown.Align = TextAnchor.MiddleCenter;
                ui.KitCooldown.Color = new IColor("#161617");
            }

            if (ui.KitAmountCooldown != null)
            {
                ui.KitAmountCooldown.ButtonColor = new IColor("#000000", 0);
                ui.KitAmountCooldown.FontSize = 14;
                ui.KitAmountCooldown.IsBold = true;
                ui.KitAmountCooldown.Align = TextAnchor.MiddleCenter;
                ui.KitAmountCooldown.Color = new IColor("#161617");
            }

            if (ui.NoPermission != null)
            {
                ui.NoPermission.FontSize = 12;
                ui.NoPermission.IsBold = true;
                ui.NoPermission.Align = TextAnchor.MiddleCenter;
                ui.NoPermission.Color = new IColor("#E2DBD3", 50);
            }
        }
        ...
        private void LoadKits()
        {
            ...
            Puts($"Loaded {_data.Kits?.Count ?? 0} kits from HarmonyData/Kits/Kits.json");
        }
        ...
        private class Kit
        {
            ...
            [JsonProperty(PropertyName = "Respawn Block (seconds, 0 = disable)")]
            public double CooldownAfterRespawn;
            ...
            public KitCurrency Currencies = new();

            [JsonProperty(PropertyName = "Default Currency (Economy ID, 0 = main economy)")]
            ...
            [JsonProperty(PropertyName = "Disable notification when kit is reserved?")]
            public bool DisableNotify = false;

            [JsonIgnore] public bool UseSlotForBackpack = true;
            ...
            public void MoveRight()
            {
                ...
                if (index >= 0 && index < _instance._data.Kits.Count - 1)
                    (_instance._data.Kits[index], _instance._data.Kits[index + 1]) = (_instance._data.Kits[index + 1],
                        _instance._data.Kits[index]); // Swap
            }
            ...
            public double GetPrice(int economyId = -1)
            {
                if (economyId == -1)
                    economyId = DefaultCurrency;

                if (Currencies is {Enabled: true} && Currencies.TryGetCurrency(economyId, out var currency))
                    return currency.Price;

                return Price;
            }

            public bool HasCurrency(int economyId)
            {
                return Currencies is {Enabled: true} && Currencies.HasCurrency(economyId);
            }

            #endregion
        }

        public class KitCurrency
        {
            [JsonProperty(PropertyName = "Enabled")]
            public bool Enabled;

            [JsonProperty(PropertyName = "Currencies for buying kit (key - economy ID, if you use economy by default use 0)", ObjectCreationHandling = ObjectCreationHandling.Replace)]
            public Dictionary<int, CurrencyInfo> Currencies = new();

            public bool TryGetCurrency(int economyId, out CurrencyInfo currency)
            {
                return Currencies.TryGetValue(economyId, out currency);
            }

            public bool HasCurrency(int economyId)
            {
                return Currencies.ContainsKey(economyId);
            }
        }
        ...
        private class KitItem
        {
            ...
            [JsonProperty(PropertyName = "Genes")] public ItemGenes Genes = new();

            [JsonProperty(PropertyName = "Content Container")]
            ...
            public void Get(BasePlayer player, bool shareItems)
            {
                ...
                switch (Type)
                {
                    ...
                    {
                        if (!_instance.CanAccesToItem(player, this)) return;
            ...
            public Item BuildItem()
            {
                ...
                if (Blueprint != 0 && ItemManager.FindBlueprint(item.info) != null)
                ...
                if (Content?.Count > 0 && item.contents != null)
                {
                ...
                if (ContentContainer is {Enabled: true})
                {
                    if (item.contents == null)
                    {
                        ...
                        if (armorSlot)
                        {
                            armorSlot.CreateAtCapacity(ContentContainer.capacity, item);
                        }
                        else
                        {
                            item.contents = Pool.Get<ItemContainer>();
                            item.contents.ServerInitialize(item, ContentContainer.capacity);
                            item.contents.GiveUID();
                        }
                    }

                    ContentContainer.LoadContainer(item.contents);
                }
            ...
            private ICuiComponent GetImageComponent()
            {
        ...
        private class ContentContainer
        {
            ...
            public int volume;
            public List<KitItem> contents;
            public List<int> availableSlots;
            public List<int> allowedItems;

            public static ContentContainer FromItemContainer(ItemContainer container)
            {
                var newContainer = new ContentContainer
                {
                    Enabled = true,
                    contents = new List<KitItem>(),
                ...
                {
                    newContainer.allowedItems = new List<int>();
                    for (var i = 0; i < container.onlyAllowedItems.Length; i++)
                        if (container.onlyAllowedItems[i])
                            newContainer.allowedItems.Add(container.onlyAllowedItems[i].itemid);
                }

                if (container.availableSlots is {Count: > 0})
                {
                    newContainer.availableSlots = new List<int>();
                    for (var i = 0; i < container.availableSlots.Count; i++)
                        newContainer.availableSlots.Add((int) container.availableSlots[i]);
                }

                for (var i = 0; i < container.itemList.Count; i++)
                    newContainer.contents.Add(ItemToKit(container.itemList[i], "contents", i));

                return newContainer;
            }

            public void LoadContainer(ItemContainer itemContainer)
            {
                ...
                itemContainer.flags = (ItemContainer.Flag) flags;
                itemContainer.allowedContents = (ItemContainer.ContentsType) allowedContents;

                if (allowedItems is {Count: > 0})
                {
                    itemContainer.onlyAllowedItems = new ItemDefinition[allowedItems.Count];
                    for (var i = 0; i < allowedItems.Count; i++)
                ...
                if (availableSlots is {Count: > 0})
                    for (var i = 0; i < availableSlots.Count; i++)
                        itemContainer.availableSlots.Add((ItemSlot) availableSlots[i]);

                if (contents is {Count: > 0})
                    for (var i = 0; i < contents.Count; i++)
                    {
                        var kitItem = contents[i];

                        var item = kitItem.BuildItem();
                        if (item == null)
                        {
                            _instance?.PrintError($"Error creating item with ShortName '{kitItem.ShortName}'");
                            continue;
                        }

                        if (!item.MoveToContainer(itemContainer, kitItem.Position) &&
        ...
        private EconomyConf GetEconomy(int economyId)
        {
            if (economyId == 0)
                return _config.Economy;

            return _additionalEconomics.TryGetValue(economyId, out var economyConf)
                ? economyConf
                : _config.Economy;
        }

        private string GetPriceFormat(BasePlayer player, Kit kit)
        {
            var economy = GetEconomy(kit.DefaultCurrency);
            var format = economy.GetPriceFormat();
            return string.Format(format, kit.GetPrice());
        }
        ...
        {
            _instance = this;
            KitsExtensionMethods.ExtensionMethods.perm = KitsHost.Instance?.Permission;
        ...
        internal void OnPlayerRespawned(BasePlayer player)
        {
            ...
            try
            {
                ...
                {
                    kits.ForEach(kit => NextTick(() => ProcessAutoKit(player, kit)));
                }
            }
            finally
            {
        ...
        internal void CmdOpenKits(IPlayer cov, string command, string[] args)
        {
            ...
            switch (args[0])
            {
                ...
                default:
                {
                    ...
                    var kit = GetAvailableKitList(player, checkAmount: false, showAll: true)
        ...
        internal void CmdKitsConsole(ConsoleSystem.Arg arg)
        {
            var player = arg?.Player() ?? arg?.Connection?.player as BasePlayer;
            if (player == null || !arg.HasArgs()) return;

#if TESTING
			SayDebug($"UI_Kits called: {string.Join(" ", arg.ToStringArray())}");
#endif
                ...
                case "main":
                {
                    ...
                    switch (arg.GetString(1))
                    {
                        case "page":
                        {
                            ...
                            UpdateUI(player, container => { MainKitsContentUI(player, container); });
                            break;
                        }
...
MainKitsContentUI(player, container); });
                ...
                case "infokit":
                {
                    if (!arg.HasArgs(2) || !int.TryParse(arg.GetString(1), out var kitId)) return;
                ...
                {
                    if (!arg.HasArgs(2) ||
                        !int.TryParse(arg.GetString(1), out var kitId)) return;
                ...
                case "editkit":
                {
                    ...
                    if (!arg.HasArgs(2) || !bool.TryParse(arg.GetString(1), out var creating)) return;

                    var kitId = -1;
                    if (arg.HasArgs(3))
                        int.TryParse(arg.GetString(2), out kitId);

                    if (arg.HasArgs(4) && (!arg.HasArgs(5) || string.IsNullOrEmpty(arg.GetString(4))))
                        return;

                    if (arg.HasArgs(5))
                    {
                        var key = arg.GetString(3);
                        var value = arg.GetString(4);
                ...
                case "takeitem":
                {
                    ...
                    if (!arg.HasArgs(6) ||
                        ...
                        !int.TryParse(arg.GetString(1), out var page) ||
                        !int.TryParse(arg.GetString(3), out var kitId) ||
                        !int.TryParse(arg.GetString(4), out var slot))
                        return;

                    var container = arg.GetString(2);

                    _itemEditing[player.userID]["ShortName"] = arg.GetString(5);
                ...
                case "selectitem":
                {
                    ...
                    if (!arg.HasArgs(4) ||
                        !_itemEditing.ContainsKey(player.userID) ||
                        !int.TryParse(arg.GetString(2), out var kitId) ||
                        !int.TryParse(arg.GetString(3), out var slot))
                        return;

                    var container = arg.GetString(1);

                    var selectedCategory = string.Empty;
                    if (arg.HasArgs(5))
                        selectedCategory = arg.GetString(4);

                    var page = 0;
                    if (arg.HasArgs(6))
                        int.TryParse(arg.GetString(5), out page);
                ...
                case "edititem":
                {
                    ...
                    if (!arg.HasArgs(6) ||
                        !int.TryParse(arg.GetString(2), out var kitId) ||
                        !int.TryParse(arg.GetString(3), out var slot)) return;

                    var container = arg.GetString(1);

                    var key = arg.GetString(4);
                    var value = arg.GetString(5);
                ...
                case "saveitem":
                {
                    ...
                    if (!arg.HasArgs(4) ||
                        !int.TryParse(arg.GetString(1), out var kitId) ||
                        !int.TryParse(arg.GetString(2), out var slot)) return;

                    var container = arg.GetString(3);
                ...
                case "removeitem":
                {
                    ...
                    var item = kit.GetItemByContainerAndPosition(arg.GetString(3), slot);
                    if (item != null)
                ...
                case "savekit":
                {
                    ...
                    if (!arg.HasArgs(3) ||
                        !bool.TryParse(arg.GetString(1), out var creating) ||
                        !int.TryParse(arg.GetString(2), out var kitId)) return;
                    ...
                    else
                    {
                        ...
                        if (oldCategory != kit.Category)
                        {
                            var openedKits = GetOpenedKits(player);

                            if (openedKits.ActiveCategory == oldCategory) openedKits.ActiveCategory = kit.Category;
                        }
                    }
                ...
                case "refresh_kit":
                {
                    ...
                    UpdateUI(player, container => { RefreshKitUi(ref container, player, kit); });
                ...
                case "category":
                {
                    var targetCategory = string.Join(" ", arg.Args.Skip(1));
                    ...
                    {
                        if (!targetUI.ShowCategoryAll) return;
                        targetCategory = null;
                    }
        ...
        internal void CmdKitsReset(ConsoleSystem.Arg arg)
        {
            var player = arg.Player();
            if (player != null || !arg.IsServerside)
            {
                if (!IsAdmin(player)) return;
            }
            ...
            switch (arg.GetString(0))
            {
                case "data":
                {
                    ...
                    {
                        SendReply(arg,
                            "Error syntax! Use: /kits.reset data [<targetID>/all] or /kits.reset data <targetID> <kitName>");
                        return;
                    }
                    ...
                    switch (targetID)
                    {
                        ...
                        default:
                        {
                            ...
                            {
                                PlayerData.DoWipe(targetID, false);

                                SendReply(arg,
                                    $"The data of the player with SteamID {targetID} has been successfully reset!");
                            }
        ...
        internal void CmdKitsGive(ConsoleSystem.Arg arg)
        {
            var player = arg.Player();
            if (player != null || !arg.IsServerside)
            {
            ...
            var nameOrSteamID = arg.GetString(0);
            ...
            Log(target, kit.Name, isGiven: true);
        }

        internal void CmdKitsGiveKit(ConsoleSystem.Arg arg)
        {
            var player = arg.Player();
            if (player != null || !arg.IsServerside)
            {
            ...
            var steamIdOrName = arg.GetString(0);
            ...
            var kit = FindKitByName(arg.GetString(1));
            if (kit == null)
            {
                SendReply(arg, $"Kit '{arg.GetString(1)}' not found!");
                return;
            }
            ...
            SendReply(arg, $"Player '{steamIdOrName}' successfully received a kit '{arg.GetString(1)}' ({amount} pcs)");

            Log(target, kit.Name, isGiven: true);
        }

        internal void CmdKitsSetTemplate(ConsoleSystem.Arg arg)
        {
            // Server console always allowed. In-game F1 / client console: admins only.
            var caller = arg?.Player();
            if (caller != null)
            {
                if (!IsAdmin(caller)) return;
            }
            else if (arg == null || !arg.IsServerside)
            {
                return;
            }
            ...
            if (!arg.HasArgs())
            {
                ...
                try
                {
                    ...
                    sb.AppendLine("    - rust:");
                    sb.AppendLine("      - normal (V1/V2/V4)");
                    sb.AppendLine("      - content (V1/V2/V4)");
                    sb.AppendLine("      - categories (V1/V2/V4)");
                    sb.AppendLine("      - content_categories (V1/V2/V4)");
                    sb.AppendLine();
                    sb.AppendLine("Examples:");
                    sb.AppendLine("  kits.template fullscreen old - Sets the fullscreen UI to the old style template.");
                    sb.AppendLine(
                        "  kits.template fullscreen rust normal - Sets the inmenu UI to the rust normal template.");
                    sb.AppendLine(
                        "  kits.template fullscreen rust content - Sets the inmenu UI to the rust content template.");
                    sb.AppendLine(
                        "  kits.template fullscreen rust categories - Sets the inmenu UI to the rust categories template.");
                    sb.AppendLine(
                        "  kits.template fullscreen rust content_categories - Sets the inmenu UI to the rust content and categories template.");
                    sb.AppendLine(
                        "  kits.template inmenu rust normal 1 - Sets the inmenu UI to the rust normal template, for ServerPanel template version 1.");
                    sb.AppendLine(
                        "  kits.template inmenu rust content 2 - Sets the inmenu UI to the rust content template, for ServerPanel template version 2.");
                    sb.AppendLine(
                        "  kits.template inmenu rust categories 1 - Sets the inmenu UI to the rust categories template, for ServerPanel template version 1.");
                    sb.AppendLine(
                        "  kits.template inmenu rust content_categories 1 - Sets the inmenu UI to the rust content and categories template, for ServerPanel template version 2.");
            ...
            if (!arg.HasArgs(2) || (format != "fullscreen" && format != "inmenu") ||
                (style != "old" && style != "rust"))
            {
                SendReply(arg,
                    $"Error syntax! Use: {arg.cmd.FullName} [fullscreen/inmenu] [old/rust] [template_type] [menu_version - if inmenu]");
                return;
            }

            if (format == "inmenu" && (!arg.HasArgs(3) || (menuVersion != 1 && menuVersion != 2 && menuVersion != 4)))
            {
                SendReply(arg,
                    $"Error syntax! For 'inmenu' you must specify a menu version (V1, V2 or V4): {arg.cmd.FullName} [fullscreen/inmenu] [old/rust] [template_type] [1/2/4]");
                return;
            }
                    ...
                    switch (style)
                    {
                        ...
                        case "rust":
                        {
                            targetTemplate = rustType switch
                            {
                                ...
                                "content_categories" => UserInterface
                                    .GenerateFullscreenTemplateWithContentsAndCategoriesRust(),
                            ...
                            switch (rustType)
                            {
                                case "content":
                                    targetTemplate = menuVersion switch
                                    {
                                        ...
                                        4 => UserInterface.GenerateMenuTemplateRustWithContentsV4(),
                                        _ => null
                                    };
                                    break;
                                case "categories":
                                    targetTemplate = menuVersion switch
                                    {
                                        ...
                                        4 => UserInterface.GenerateMenuTemplateRustWithCategoriesV4(),
                                        _ => null
                                    };
                                    break;
                                case "content_categories":
                                    targetTemplate = menuVersion switch
                                    {
                                        ...
                                        4 => UserInterface.GenerateMenuTemplateRustWithContentsAndCategoriesV4(),
                                        _ => null
                                    };
                                    break;
                                default:
                                    targetTemplate = menuVersion switch
                                    {
                                        ...
                                        4 => UserInterface.GenerateMenuTemplateRustV4(),
                                        _ => null
                                    };
                                    break;
                            }
        ...
        private void MainKitsContentUI(BasePlayer player, CuiElementContainer container, bool first = false)
        {
            ...
            if (openedKits.HasPages())
            {
                ...
                container.AddRange(
                    targetUI.ContentPanel.ButtonNext.GetButton(">", openedKits.availableKits.Count >
                                                                    (openedKits.currentPage + 1) *
                                                                    openedKits.GetTotalKitsAmount()
                            ? $"UI_Kits main page {openedKits.currentPage + 1}"
                            : "",
                        Layer + ".Content"));
            }
            ...
            if (IsAdmin(player))
            {
                ...
                container.Add(targetUI.ContentPanel.CheckboxShowAllKits.Background.GetImage(Layer + ".Content",
                    Layer + ".Content" + ".Admin.Show.All", Layer + ".Content" + ".Admin.Show.All"));

                container.AddRange(targetUI.ContentPanel.CheckboxShowAllKits.CheckboxButton.GetButton(
                    openedKits.showAll ? "✔" : string.Empty, $"UI_Kits main show_all {!openedKits.showAll}",
                    Layer + ".Content" + ".Admin.Show.All", Layer + ".Content" + ".Admin.Show.All.Check",
                    Layer + ".Content" + ".Admin.Show.All.Check"));

                CreateOutLine(ref container, Layer + ".Content" + ".Admin.Show.All.Check",
                    targetUI.ContentPanel.CheckboxShowAllKits.CheckboxColor.Get(),
                    targetUI.ContentPanel.CheckboxShowAllKits.CheckboxSize);

                container.Add(targetUI.ContentPanel.CheckboxShowAllKits.Title.GetText(Msg(player, ShowAll),
                    Layer + ".Content" + ".Admin.Show.All.Check"));

                #endregion Check Show All

                container.AddRange(
                    targetUI.ContentPanel.ButtonCreateKit.GetButton(Msg(player, CreateKit), "UI_Kits editkit True",
                        Layer + ".Content"));
            }
        ...
        private void MainKitsCategories(BasePlayer player, CuiElementContainer container)
        {
            ...
            try
            {
                ...
                var totalHeight = categories.Count * targetUI.Categories.Width +
                                  (categories.Count - 1) * targetUI.Categories.Margin;
                ...
                var activeCat = openedKits.ActiveCategory;

                if (string.IsNullOrEmpty(activeCat))
                {
                    if (targetUI.ShowCategoryAll)
                    {
                        activeCat = CategoryAll;
                    }
                    else if (categories.Count > 0)
                    {
                        activeCat = categories[0];
                        openedKits.ActiveCategory = activeCat;
                        openedKits.UpdateKits();
                    }
                }

                if (!categories.Contains(activeCat))
                {
                    activeCat = categories[0];
                    openedKits.ActiveCategory = activeCat == CategoryAll ? null : activeCat;
                    openedKits.UpdateKits();
                }
                ...
                for (var i = 0; i < categories.Count; i++)
                {
                    ...
                    container.AddRange((isActiveCat
                        ...
                        : targetUI.Categories.InactiveCategory).GetButton(Msg(player, targetCategory),
                        isActiveCat ? string.Empty : $"UI_Kits category {targetCategory}",
                        Layer + ".Categories.ScrollView", categoryLayer, categoryLayer,
                        rect: new CuiRectTransformComponent
                        {
                            AnchorMin = "0 1", AnchorMax = "0 1",
                            OffsetMin = $"{offsetLeft} -{targetUI.Categories.Height}",
                            OffsetMax = $"{offsetLeft + targetUI.Categories.Width} 0"
                        }));
                }
        ...
        private void MainKitsListUI(BasePlayer player, CuiElementContainer container)
        {
            ...
            if (targetUI.UseScroll)
            {
                var totalKits = openedKits.kitsToUpdate.Count;
                var isVertical = targetUI.KitScrollSettings.ScrollType == ScrollType.Vertical;
                var maxVisibleKits = targetUI.KitsOnString * targetUI.Strings;

                if (totalKits <= maxVisibleKits)
                {
                    ShowGridUI(container, 0,
                        ...
                        index => Layer + $".Kit.{openedKits.kitsToUpdate[index].ID}.Main",
                        index => KitUI(player, container, openedKits.kitsToUpdate[index], 0, totalKits,
                            index, isAdmin, openedKits.showAll));
                }
                else
                {
                    var scrollParent = Layer + ".Content.Kits.ScrollView";
                    float totalContentSize;

                    if (isVertical)
                    {
                        var kitsOnString = targetUI.KitsOnString;
                        var totalRows = Mathf.CeilToInt((float)totalKits / kitsOnString);
                        totalContentSize = totalRows * targetUI.KitHeight
                                         + Mathf.Max(0, totalRows - 1) * targetUI.Margin
                                         + 5f;

                        container.Add(new CuiElement
                        {
                            Name = scrollParent,
                            DestroyUi = scrollParent,
                            Parent = Layer + ".Content",
                            Components =
                            {
                                new CuiImageComponent { Color = "0 0 0 0" },
                                targetUI.KitScrollSettings.GetScrollView(
                                    targetUI.KitScrollSettings.CalculateContentRectTransform(totalContentSize)),
                                new CuiRectTransformComponent
                                {
                                    AnchorMin = "0 0", AnchorMax = "1 1",
                                    OffsetMin = "0 0",
                                    OffsetMax = $"0 {targetUI.YIndent}"
                                }
                            }
                        });

                        var xSwitch = Mathf.Max(0, targetUI.LeftIndent - 10);
                        var ySwitch = 5f;

                        for (var i = 0; i < totalKits; i++)
                        {
                            var kit = openedKits.kitsToUpdate[i];
                            var panelName = Layer + $".Kit.{kit.ID}.Main";
                            ...
                            container.Add(new CuiPanel
                            {
                                ...
                                {
                                    AnchorMin = "0 1", AnchorMax = "0 1",
                                    OffsetMin = $"{xSwitch} {ySwitch - targetUI.KitHeight}",
                                    OffsetMax = $"{xSwitch + targetUI.KitWidth} {ySwitch}"
                                },
                                Image = { Color = "0 0 0 0" }
                            }, scrollParent, panelName, panelName);

                            KitUI(player, container, kit, 0, totalKits, i, isAdmin, openedKits.showAll);

                            if ((i + 1) % kitsOnString == 0)
                            {
                                xSwitch = Mathf.Max(0, targetUI.LeftIndent - 10);
                                ySwitch -= targetUI.KitHeight + targetUI.Margin;
                            }
                            else
                            {
                                xSwitch += targetUI.KitWidth + targetUI.Margin;
                            }
                        }
                    }
                    else
                    {
                        var strings = targetUI.Strings;
                        var itemsInColumn = strings;
                        var totalColumns = Mathf.CeilToInt((float)totalKits / itemsInColumn);
                        totalContentSize = totalColumns * targetUI.KitWidth
                                         + Mathf.Max(0, totalColumns - 1) * targetUI.Margin
                                         + targetUI.LeftIndent;
                        ...
                        container.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                ...
                                {
                                    AnchorMin = "0 0", AnchorMax = "1 1",
                                    OffsetMin = $"0 {targetUI.YIndent + 5}",
                                    OffsetMax = $"0 {targetUI.YIndent}"
                                }
                            }
                        });

                        var xSwitch = targetUI.LeftIndent;
                        var ySwitch = 5f;
            ...
            bool kitsShowAll)
        {
            ...
            {
                #region Number
                // Kit # is drawn under the status strip in RefreshKitUi (not behind the image).
                #endregion

                #region Image

                if (!string.IsNullOrEmpty(kit.Image) && _enabledImageLibrary && !string.IsNullOrEmpty(GetImage(kit.Image)))
                {
                    container.Add(new CuiElement
                    {
                ...
                {
                    // No custom kit image — show built-in item icons (itemid) in the image slot
                    AddKitItemsPreview(container, kit,
                        Layer + $".Kit.{kit.ID}.Main.Background",
                        targetUI.KitPanel.KitImage);
                }
        ...
        private int ResolveKitDisplayNumber(OpenedKits openedKits, Kit kit)
        {
            if (openedKits?.kitsToUpdate == null || kit == null) return 0;
            var idx = openedKits.kitsToUpdate.FindIndex(k => k != null && k.ID == kit.ID);
            if (idx < 0) return 0;
            return openedKits.currentPage * openedKits.GetTotalKitsAmount() + idx + 1;
        }

        /// <summary>
        /// Small kit index under the status strip (Available / cooldown / no-perm), not behind the image.
        /// </summary>
        private void AddKitNumberUnderStatus(CuiElementContainer container, BasePlayer player, Kit kit)
        {
            var openedKits = GetOpenedKits(player);
            if (openedKits == null) return;

            var targetUI = openedKits.useMainUI ? _config.UI : _config.MenuUI;
            if (targetUI?.KitPanel == null || !targetUI.KitPanel.ShowNumber) return;
            if (targetUI.KitPanel.DisplayKitContents) return;

            var number = ResolveKitDisplayNumber(openedKits, kit);
            if (number <= 0) return;

            // Just under the status strip (status panel sits around y 50–90 on Main)
            var parent = Layer + $".Kit.{kit.ID}.Main";
            var name = Layer + $".Kit.{kit.ID}.Number";
            container.Add(new CuiLabel
            {
                RectTransform =
                {
                ...
                Text =
                {
                    ...
                    Align = TextAnchor.MiddleCenter,
                    Font = "robotocondensed-regular.ttf",
                    Color = "0.886 0.859 0.827 0.55"
                }
            }, parent, name, name);
        }

        /// <summary>
        /// Compact item-icon grid using vanilla CuiImage itemid icons (no custom images needed).
        /// Fills the kit image rect when a kit has no Image URL.
        /// </summary>
        private void AddKitItemsPreview(CuiElementContainer container, Kit kit, string parent,
            InterfacePosition imageSlot)
        {
            if (kit?.Items == null || kit.Items.Count == 0 || imageSlot == null) return;

            var previewRoot = parent + ".ItemsPreview";
            container.Add(new CuiPanel
            {
                RectTransform =
                {
                    AnchorMin = imageSlot.AnchorMin,
                    AnchorMax = imageSlot.AnchorMax,
                    OffsetMin = imageSlot.OffsetMin,
                    OffsetMax = imageSlot.OffsetMax
                },
                Image = { Color = "0 0 0 0" }
            }, parent, previewRoot, previewRoot);
            ...
            // Estimate slot size from typical Kit Image box (~120x120). Keep icons readable.
            ...
            // Center the grid inside the preview box
            var gridW = columns * cell + (columns - 1) * gap;
            var gridH = rows * cell + (rows - 1) * gap;
            var startX = -gridW * 0.5f;
            var startY = gridH * 0.5f;

            for (var i = 0; i < count; i++)
            {
                var kitItem = items[i];
                if (kitItem == null || string.IsNullOrEmpty(kitItem.ShortName)) continue;

                var col = i % columns;
                var row = i / columns;
                var xMin = startX + col * (cell + gap);
                var yMax = startY - row * (cell + gap);
                var xMax = xMin + cell;
                var yMin = yMax - cell;

                var slotName = previewRoot + $".{i}";
                container.Add(new CuiPanel
                {
                    RectTransform =
                    {
                        AnchorMin = "0.5 0.5",
                        AnchorMax = "0.5 0.5",
                        OffsetMin = $"{xMin:0.##} {yMin:0.##}",
                        OffsetMax = $"{xMax:0.##} {yMax:0.##}"
                    },
                    Image = { Color = "0 0 0 0" }
                }, previewRoot, slotName);

                container.Add(kitItem.GetImage(
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0",
                        AnchorMax = "1 1",
        ...
        private void MainKitsHeader(BasePlayer player, CuiElementContainer container)
        {
            ...
            container.Add(
                targetUI.HeaderPanel.Background.GetImage(Layer + ".Main", Layer + ".Header", Layer + ".Header"));
            ...
            if (openedKits.useMainUI)
                container.AddRange(targetUI.HeaderPanel.ButtonClose.GetButton(Msg(player, Close), "UI_Kits close",
                    Layer + ".Header", close: Layer));
        }
        ...
        private void MainKitsBackground(BasePlayer player, CuiElementContainer container)
        {
            ...
            container.Add(targetUI.MainBackground.GetImage("OverlayNonScaled", Layer, Layer));
            ...
            switch (targetUI.Style)
            {
                case InterfaceStyle.NewRust:
                {
                    ...
                    container.Add(new CuiPanel
                    {
                        ...
                        CursorEnabled = true
                    }, "OverlayNonScaled", InfoLayer, InfoLayer);
                    ...
                    container.Add(new CuiElement
                    {
                        ...
                        Components =
                        {
                            ...
                            new CuiRectTransformComponent
                            {
                                AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-250 225",
                                OffsetMax = "220 265"
                            }
                        }
                    });
                    ...
                    if (IsAdmin(player))
                        container.Add(new CuiButton
                        {
                            Text =
                            {
                                Text = Msg(player, Edit), Font = "robotocondensed-bold.ttf", FontSize = 14,
                                Align = TextAnchor.MiddleCenter, Color = HexToCuiColor("#71B8ED")
                            },
                            Button =
                            {
                                Command = $"UI_Kits editkit {false} {kit.ID}",
                            ...
                            RectTransform =
                            {
                                AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "70 230",
                                OffsetMax = "185 260"
                            }
                        }, InfoLayer);
                    ...
                    var buttonClose = container.Add(new CuiButton
                    {
                        ...
                        RectTransform =
                            {AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "190 230", OffsetMax = "220 260"}
                    }, InfoLayer);
                    ...
                    container.Add(new CuiElement
                    {
                        ...
                        Components =
                        {
                            ...
                            new CuiRectTransformComponent
                                {AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-8 -8", OffsetMax = "8 8"}
                        }
                    });
                    ...
                    container.Add(new CuiPanel
                        {
                            ...
                            RectTransform =
                            {
                                AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-250 -85",
                                OffsetMax = "220 225"
                            }
                        }, InfoLayer, InfoLayer + $".Container.{itemContainer}.Section",
                    ...
                    container.Add(new CuiPanel
                        {
                            ...
                            RectTransform =
                            {
                                AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-275 -175",
                                OffsetMax = "275 -105"
                            }
                        }, InfoLayer, InfoLayer + $".Container.{itemContainer}.Section",
                        InfoLayer + $".Container.{itemContainer}.Section");
                    ...
                    container.Add(new CuiPanel
                        {
                            ...
                            RectTransform =
                            {
                                AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-235 -265",
                                OffsetMax = "235 -195"
                            }
                        }, InfoLayer, InfoLayer + $".Container.{itemContainer}.Section",
                        InfoLayer + $".Container.{itemContainer}.Section");
        ...
        private void InfoKitItemUI(BasePlayer player, Kit kit, CuiElementContainer container, int slot,
            string itemContainer)
        {
            ...
            if (kitItem != null)
            {
                ...
                if (!CanAccesToItem(player, kitItem))
                    container.Add(new CuiPanel
                        {
                            RectTransform =
                            {
        ...
        internal void editKitCommand(BasePlayer player, string command, string[] args)
        {
            ...
            var kitId = _kitByName.FirstOrDefault(k => k.Value == index);
        ...
        private void EditingKitUi(BasePlayer player, bool creating, int kitId = -1)
        {
            ...
            }, "OverlayNonScaled", EditingLayer, EditingLayer);
        ...
        {
            var targetUI = _openKITS.TryGetValue(player.userID, out var ok) && !ok.useMainUI
                ? _config.MenuUI
                : _config.UI;
            var modal = targetUI.ErrorModal;
            ...
            {
                {
                    new CuiPanel
                    {
                        RectTransform = {AnchorMin = modal.Background.AnchorMin, AnchorMax = modal.Background.AnchorMax},
                        Image = {Color = modal.Background.Color.Get()},
                        CursorEnabled = modal.Background.CursorEnabled
                    },
                    "OverlayNonScaled", ModalLayer, ModalLayer
                },
                {
                    new CuiPanel
                    {
                        RectTransform =
                        {
                            AnchorMin = modal.MainPanel.AnchorMin,
                            AnchorMax = modal.MainPanel.AnchorMax,
                            OffsetMin = modal.MainPanel.OffsetMin,
                            OffsetMax = modal.MainPanel.OffsetMax
                        },
                        Image = {Color = modal.MainPanel.Color.Get()}
                    },
                    ModalLayer, ModalLayer + ".Main"
                },
                {
                    new CuiLabel
                    {
                        RectTransform =
                        {
                            AnchorMin = modal.Title.AnchorMin, AnchorMax = modal.Title.AnchorMax,
                            OffsetMin = modal.Title.OffsetMin, OffsetMax = modal.Title.OffsetMax
                        },
                        Text =
                        {
                            Text = Msg(player, UI_Error_Title),
                            Align = modal.Title.Align,
                            Font = modal.Title.IsBold ? "robotocondensed-bold.ttf" : "robotocondensed-regular.ttf",
                            FontSize = modal.Title.FontSize,
                            Color = modal.Title.Color.Get()
                        }
                    },
                    ModalLayer + ".Main"
                },
                {
                    new CuiLabel
                    {
                        RectTransform =
                        {
                            AnchorMin = modal.Message.AnchorMin, AnchorMax = modal.Message.AnchorMax,
                            OffsetMin = modal.Message.OffsetMin, OffsetMax = modal.Message.OffsetMax
                        },
                        Text =
                        {
                            Text = msg ?? string.Empty,
                            Align = modal.Message.Align,
                            Font = modal.Message.IsBold ? "robotocondensed-bold.ttf" : "robotocondensed-regular.ttf",
                            FontSize = modal.Message.FontSize,
                            Color = modal.Message.Color.Get()
                        }
                    },
                    ModalLayer + ".Main"
                },
                {
                    new CuiButton
                    {
                        RectTransform =
                        {
                            AnchorMin = modal.CloseButton.AnchorMin, AnchorMax = modal.CloseButton.AnchorMax,
                            OffsetMin = modal.CloseButton.OffsetMin, OffsetMax = modal.CloseButton.OffsetMax
                        },
                        Text =
                        {
                            Text = Msg(player, BtnClose),
                            Align = modal.CloseButton.Align,
                            Font = modal.CloseButton.IsBold ? "robotocondensed-bold.ttf" : "robotocondensed-regular.ttf",
                            FontSize = modal.CloseButton.FontSize,
                            Color = modal.CloseButton.Color.Get()
                        },
                        Button = {Color = modal.CloseButton.ButtonColor.Get(), Close = ModalLayer}
                    },
                    ModalLayer + ".Main"
                }
            };
            ...
            object fieldValue)
        {
            ...
            CreateOutLine(ref container, $"{name}.Value", HexToCuiColor("#161617"));
            ...
            bool value)
        {
            ...
            CreateOutLine(ref container, name, HexToCuiColor("#161617"));
            ...
            switch (targetUI.Style)
            {
                case InterfaceStyle.NewRust:
                {
                    if (targetUI.KitPanel.DisplayKitContents)
                    {
                        ...
                        if (kit.Amount > 0)
                            container.Add(targetUI.KitPanel.Contents.KitAmount.GetText(
                                Msg(player, UI_MeventRust_Amount, playerData.Amount, kit.Amount),
                                Layer + $".Kit.{kit.ID}"));
                        ...
                        if (IsKitCooldown(kit, playerData, currentTime, out var isCooldown, out var wipeBlock))
                        {
                            ...
                            if (kit.Amount > 0)
                            {
                                container.Add(new CuiElement
                                {
                                    ...
                                    Components =
                                    {
                                        targetUI.KitPanel.Contents.KitCooldownWithAmount.GetButtonComponent(
                                ...
                                container.Add(new CuiElement
                                {
                                    ...
                                    Components =
                                    {
                                        new CuiTextComponent
                                        {
                                            ...
                                            Font = targetUI.KitPanel.Contents.KitCooldownWithAmount.IsBold
                            ...
                            else
                            {
                                container.Add(new CuiElement
                                {
                                    ...
                                    Components =
                                    {
                                        targetUI.KitPanel.Contents.KitCooldown.GetButtonComponent(string.Empty,
                                            string.Empty),
                                ...
                                container.Add(new CuiElement
                                {
                                    ...
                                    Components =
                                    {
                                        new CuiTextComponent
                                        {
                                            ...
                                            Font = targetUI.KitPanel.Contents.KitCooldown.IsBold
                                                ? "robotocondensed-bold.ttf"
                                                : "robotocondensed-regular.ttf",
                        ...
                        {
                            if (kit.Sale)
                                container.AddRange(targetUI.KitPanel.Contents.KitSale.GetButton(
                                    GetPriceFormat(player, kit),
                                    $"UI_Kits givekit {kit.ID}", Layer + $".Kit.{kit.ID}",
                        ...
                        var constSwitch = -(amountOnString * targetUI.KitPanel.Contents.Size +
                                            (amountOnString - 1) * targetUI.KitPanel.Contents.Margin) / 2f;
                        ...
                        constSwitch = -(amountOnString * targetUI.KitPanel.Contents.Size +
                                        (amountOnString - 1) * targetUI.KitPanel.Contents.Margin) / 2f;
                    ...
                    else
                    {
                            ...
                            container.Add(new CuiLabel
                                {
                                    ...
                                    Text =
                                    {
                                        ...
                                        Font = targetUI.NoPermission.IsBold
                                            ? "robotocondensed-bold.ttf"
                                            : "robotocondensed-regular.ttf",
                                        FontSize = targetUI.NoPermission.FontSize,
                                        Align = targetUI.NoPermission.Align,
                                        Color = targetUI.NoPermission.Color.Get()
                                    }
                                }, Layer + $".Kit.{kit.ID}");
                            AddKitNumberUnderStatus(container, player, kit);
                            return;
                        }
                                ...
                                container.Add(new CuiPanel
                                    {
                                        RectTransform =
                                        {
                                            ...
                                            OffsetMin = $"{xSwitch} {targetUI.KitAmount.GetOffsetYMin()}",
                                            OffsetMax = $"{xSwitch + width} {targetUI.KitAmount.GetOffsetYMax()}"
                                        },
                                        Image =
                                        {
                                            Color = targetUI.KitAmount.BarColor.Get(),
                                            Material = targetUI.KitAmount.BarMaterial
                                        }
                                    }, Layer + $".Kit.{kit.ID}");
                        ...
                        else
                        {
                            ...
                            if (IsKitCooldown(kit, playerData, currentTime, out var isCooldown, out var wipeBlock))
                            {
                                ...
                                if (kit.Amount > 0)
                                {
                                    container.Add(new CuiElement
                                    {
                                        ...
                                        Components =
                                        {
                                            targetUI.KitAmountCooldown.GetButtonComponent(string.Empty, string.Empty),
                                            targetUI.KitAmountCooldown.GetRectTransform()
                                        }
                                    });
                                    ...
                                    container.Add(new CuiElement
                                    {
                                        ...
                                        Components =
                                        {
                                            ...
                                            {
                                                Text = "%TIME_LEFT%",
                                                Font = targetUI.KitAmountCooldown.IsBold
                                                    ? "robotocondensed-bold.ttf"
                                                    : "robotocondensed-regular.ttf",
                                                FontSize = targetUI.KitAmountCooldown.FontSize,
                                                Align = targetUI.KitAmountCooldown.Align,
                                                Color = targetUI.KitAmountCooldown.Color.Get()
                                            },
                                            new CuiRectTransformComponent
                                            {
                                ...
                                else
                                {
                                    container.Add(new CuiElement
                                    {
                                        ...
                                        Components =
                                        {
                                            targetUI.KitCooldown.GetButtonComponent(string.Empty, string.Empty),
                                            targetUI.KitCooldown.GetRectTransform()
                                        }
                                    });
                                    ...
                                    container.Add(new CuiElement
                                    {
                                        ...
                                        Components =
                                        {
                                            ...
                                            {
                                                Text = "%TIME_LEFT%",
                                                Font = targetUI.KitCooldown.IsBold
                                                    ? "robotocondensed-bold.ttf"
                                                    : "robotocondensed-regular.ttf",
                                                FontSize = targetUI.KitCooldown.FontSize,
                                                Align = targetUI.KitCooldown.Align,
                                                Color = targetUI.KitCooldown.Color.Get()
                                            },
                                            new CuiRectTransformComponent
                                            {
                                                AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0",
                                    ...
                                    container.Add(new CuiLabel
                                        {
                                            ...
                                            Text =
                                            {
                                                Text = GetPriceFormat(player, kit),
                                                Align = TextAnchor.MiddleCenter,
                                                Font = "robotocondensed-bold.ttf",
                                                FontSize = 12,
                                                Color = "1 1 1 1"
                                    ...
                                    container.Add(new CuiLabel
                                        {
                                            ...
                                            Text =
                                            {
                                                ...
                                                Align = TextAnchor.UpperCenter, Color = targetUI.ColorOne.Get()
                                            }
                                        }, Layer + $".Kit.{kit.ID}");
                                }
                            }
                            ...
                            if (kit.Amount > 0)
                            {
                                var kitAmountWidth = targetUI.KitAmount.Width;
                                    ...
                                    container.Add(new CuiPanel
                                        {
                                            ...
                                            {
                                                Color = i < hasAmount
                                                    ? targetUI.KitAmount.UsedBarColor.Get()
                                                    : targetUI.KitAmount.BarColor.Get(),
                                                Material = targetUI.KitAmount.BarMaterial
                                            }
                                        }, Layer + $".Kit.{kit.ID}");
            ...
            bool chat = false, bool usingUI = true)
        {
            ...
            Log(player, kit.Name, isGiven: false);
        ...
        private bool CanPlayerRedeemKit(BasePlayer player, Kit kit, bool force, bool chat)
        {
            ...
            var (status, errorMessage) = CheckConditionsForKit(player, kit, playerData);
            if (status) return true;

            SendMessageToNotifyOrUI(player, errorMessage, 1, chat);
            return false;
        }
        ...
        {
            if (player.IsDead()) return (false, Msg(player, PlayerDead));
            ...
            var bypassCooldown = player.HasPermission(PERM_BYPASS_COOLDOWN);

            if (!bypassCooldown && kit.CooldownAfterWipe > 0)
            {
            ...
            if (kit.CooldownAfterRespawn > 0)
            {
                var secondsAlive = player.lifeStory?.secondsAlive ?? 0;
                if (secondsAlive < kit.CooldownAfterRespawn)
                {
                    var leftTime = kit.CooldownAfterRespawn - secondsAlive;
                    return (false, Msg(player, KitCooldown,
                        FormatShortTime(TimeSpan.FromSeconds(leftTime))));
                }
            }
            ...
            {
                if (kit.Amount > 0 && playerData.Amount >= kit.Amount && !player.HasPermission(PERM_BYPASS_LIMIT)) return (false, Msg(player, KitLimit));

                var currentTime = GetCurrentTime();

                if (!bypassCooldown && kit.Cooldown > 0 && playerData.Cooldown > currentTime)
                    return (false, Msg(player, KitCooldown,
                        FormatShortTime(TimeSpan.FromSeconds(playerData.Cooldown - currentTime))));
            }

            if (!HasEnoughSpace(player, kit)) return (false, Msg(player, NotEnoughSpace));

            if (playerData is not {HasAmount: > 0} && kit.Sale)
            {
                var price = kit.GetPrice();
                var economy = GetEconomy(kit.DefaultCurrency);
                if (!economy.RemoveBalance(player, price))
                    return (false, Msg(player, NotMoney));
            }

            if (kit.UseBuilding && !string.IsNullOrEmpty(kit.Building) && CopyPaste != null && CopyPaste.IsLoaded)
            {
        ...
        private const int MaxWearSlots = 8, MaxMainSlots = 24, MaxBeltSlots = 6;

        private bool HasEnoughSpace(BasePlayer player, Kit kit)
        {
            var wearFree = MaxWearSlots - player.inventory.containerWear.itemList.Count;
            var mainFree = MaxMainSlots - player.inventory.containerMain.itemList.Count;
            var beltFree = MaxBeltSlots - player.inventory.containerBelt.itemList.Count;

            var totalKitItems = kit.beltCount + kit.wearCount + kit.mainCount;

            return (wearFree >= kit.wearCount && beltFree >= kit.beltCount && mainFree >= kit.mainCount) ||
                   totalKitItems <= mainFree + beltFree;
        }
        ...
        {
            for (var i = 0; i < kit.Items.Count; i++) kit.Items[i]?.Get(player, kit.ShareItemsFromKit);
        }
        ...
        {
            var wear = player.inventory.containerWear.itemList;
            var main = player.inventory.containerMain.itemList;
            var belt = player.inventory.containerBelt.itemList;

            var capacity = wear.Count + main.Count + belt.Count;
            var kitItems = new List<KitItem>(capacity);

            for (var i = 0; i < wear.Count; i++)
            {
                var it = wear[i];
                if (it == null || it.IsLocked()) continue;
                kitItems.Add(ItemToKit(it, "wear", i));
            }
            ...
            for (var i = 0; i < main.Count; i++)
            {
                var it = main[i];
                if (it == null || it.IsLocked()) continue;
                kitItems.Add(ItemToKit(it, "main", i));
            }
            ...
            for (var i = 0; i < belt.Count; i++)
            {
                var it = belt[i];
                if (it == null || it.IsLocked()) continue;
                kitItems.Add(ItemToKit(it, "belt", i));
            }

            return kitItems;
        }

        private static KitItem ItemToKit(Item item, string container, int fallbackPosition = -1)
        {
            var kitItem = new KitItem
            {
                ...
                Chance = 100,
                Command = string.Empty,
                Position = item.position >= 0 ? item.position : fallbackPosition,
                Text = item.text,
                Image = string.Empty,
                Genes = new ItemGenes
                {
            ...
            if (item.contents != null) kitItem.ContentContainer = ContentContainer.FromItemContainer(item.contents);
        ...
        private bool CanAccesToItem(BasePlayer player, KitItem item)
        {
            if (player == null || item == null || !player.IsHuman() || player.HasPermission(PERM_DLC)) return true;

            return Native_IsOwnedOrFreeItem(player, item.itemId, item.SkinID);
        }
        ...
        private class OpenedKits
        {
            ...
            public void OnChangeCurrentPage(int page)
            {
                ...
                if (availableKits.Count <= currentPage * GetTotalKitsAmount())
            ...
            {
                var targetUI = useMainUI ? _instance._config.UI : _instance._config.MenuUI;
                if (targetUI.UseScroll) return false;
                return availableKits.Count > GetTotalKitsAmount();
            }
        ...
        {
            var openedKits = new OpenedKits(player, targetID);
        ...
        private void RegisterPermissions()
        {
            ...
            permission.RegisterPermission(PERM_DLC, this);
            permission.RegisterPermission(PERM_BYPASS_COOLDOWN, this);
            permission.RegisterPermission(PERM_BYPASS_LIMIT, this);
        ...
        private void LoadImages()
        {
            ...
            _data.Kits.ForEach(kit =>
            {
                RegisterImage(kit.Image, kit.Image);
            ...
            RegisterButtonSettingsImages(_config.UI);
            RegisterButtonSettingsImages(_config.MenuUI);
            ...
            timer.In(1f, () =>
            {
                ...
                {
                    // Harmony: no ImageLibrary — load HTTP/file images into FileStorage ourselves
                    // so the UI still works from HarmonyConfig/HarmonyData kit definitions.
                    _enabledImageLibrary = true;
                    foreach (var kv in imagesList)
                    {
                        if (string.IsNullOrEmpty(kv.Value)) continue;
                        if (kv.Value.IsURL())
                            LoadImageFromUrl(kv.Key, kv.Value);
                        else if (kv.Value.StartsWith("TheMevent/", StringComparison.OrdinalIgnoreCase))
                            LoadImageFromFS(kv.Key, kv.Value);
                    }
                    Puts($"Built-in image loader active ({imagesList.Count} images queued; OfflineImageMode={_config.EnableOfflineImageMode})");
                    return;
                }
            ...
            void RegisterButtonSettingsImages(UserInterface ui)
            {
                RegisterButtonImage(ui.HeaderPanel.ButtonClose);
                RegisterButtonImage(ui.ContentPanel.ButtonBack);
                RegisterButtonImage(ui.ContentPanel.ButtonNext);
                RegisterButtonImage(ui.ContentPanel.ButtonCreateKit);
                RegisterButtonImage(ui.ContentPanel.CheckboxShowAllKits.CheckboxButton);
                RegisterButtonImage(ui.Categories.ActiveCategory);
                RegisterButtonImage(ui.Categories.InactiveCategory);
                RegisterButtonImage(ui.KitPanel.KitButtonTake);
                RegisterButtonImage(ui.KitPanel.KitButtonTakeWhenShowInfo);
                RegisterButtonImage(ui.KitPanel.KitButtonInfo);
                RegisterButtonImage(ui.KitPanel.Contents.KitCooldown);
                RegisterButtonImage(ui.KitPanel.Contents.KitCooldownWithAmount);
                RegisterButtonImage(ui.KitPanel.Contents.KitSale);
                RegisterButtonImage(ui.KitCooldown);
                RegisterButtonImage(ui.KitAmountCooldown);
                RegisterButtonImage(ui.ErrorModal.CloseButton);
            }

            void RegisterButtonImage(ButtonSettings button)
            {
                if (button == null) return;
                if (!string.IsNullOrEmpty(button.Image) && !button.Image.StartsWith("assets/"))
                    RegisterImage(button.Image, button.Image);
            }
        }
        ...
        private void LoadImageFromUrl(string name, string url)
        {
            if (string.IsNullOrEmpty(name) || string.IsNullOrEmpty(url)) return;
            Global.Runner.StartCoroutine(LoadImageHttp(name, url));
        }

        private IEnumerator LoadImageHttp(string name, string url)
        {
            ...
            {
                _instance?.PrintWarning($"Image download failed: {url} ({www.error})");
                yield break;
            }
            ...
            bool checkAmount = true, bool gui = false)
        {
            ...
            return _data.Kits.FindAll(kit =>
                IsKitAvailable(player, targetId, checkAmount, gui, kit, DEFAULT_MAIN_TARGET_ID.ToString()));
        }
        ...
        private List<Kit> GetAvailableKits(BasePlayer player, bool checkOpenedKits = true)
        {
            ...
            var showCategoryAll = true;

            if (checkOpenedKits)
            {
                var openedKits = GetOpenedKits(player);
                showCategoryAll = (openedKits.useMainUI ? _config.UI : _config.MenuUI).ShowCategoryAll;
                ...
                if (openedKits.showAll && IsAdmin(player))
                {
                    ...
                    return _data.Kits.FindAll(k => k.Category == openedKits.ActiveCategory
                                                   || (!showCategoryAll && string.IsNullOrEmpty(k.Category)));
                }
            ...
            return _data.Kits.FindAll(kit => IsKitAvailable(player, targetId.ToString(), true, true, kit,
                DEFAULT_MAIN_TARGET_ID.ToString(), activeCategory, showCategoryAll));
        }

        private bool IsKitAvailable(BasePlayer player, string targetId, bool checkAmount, bool gui, Kit kit,
            string ignoredTargetID,
            string activeCategory = null, bool showCategoryAll = true)
        {
            if ((kit.Hide || (gui && _config.KitsHidden.Contains(kit.Name)))
                && (string.IsNullOrEmpty(kit.Permission) || !player.HasPermission(kit.Permission)))
                return false;

            if (!string.IsNullOrEmpty(activeCategory) && activeCategory != kit.Category
                && (showCategoryAll || !string.IsNullOrEmpty(kit.Category)))
                return false;
        ...
        {
            var kits = Pool.Get<List<Kit>>();

            for (var i = 0; i < _data.Kits.Count; i++)
            {
                var kit = _data.Kits[i];

                if ((kit.Name == "autokit" || (_config.AutoKits.Contains(kit.Name) &&
                                                          (string.IsNullOrEmpty(kit.Permission) ||
                                                           player.HasPermission(kit.Permission))))
                    && (_config.IgnoreAutoKitChecking || CheckConditionsForKit(player, kit, PlayerData.GetOrCreateKitData(player.UserIDString, kit.Name)).Success))
                {
                    kits.Add(kit);
                }
            }
        ...
        internal bool IsAdmin(BasePlayer player)
        {
        ...
        private void Log(BasePlayer player, string kitname, bool isGiven = false)
        {
            if (player == null) return;

            var text = isGiven
                ? $"{player.displayName}[{player.UserIDString}] - Given Kit: {kitname}"
                : $"{player.displayName}[{player.UserIDString}] - Claimed Kit: {kitname}";
            ...
            var discordSettings = isGiven ? _config.DiscordConfig.Give : _config.DiscordConfig.Receive;
            if (discordSettings != null && discordSettings.Enabled && !string.IsNullOrEmpty(discordSettings.Webhook))
            {
                SendDiscordMessage(discordSettings.Webhook, discordSettings, player.displayName, player.UserIDString,
                    kitname, isGiven);
            }
        }

        private void SendDiscordMessage(string webhook, Configuration.DiscordSettings.DiscordLogSettings settings,
            string playerName, string steamId, string kitName, bool isGiven)
        {
            var embed = new Embed();
        ...
        private string[] GetKitContents(string name)
        {
            ...
            foreach (var item in kit.Items)
            {
                ...
                if (item.ContentContainer?.contents?.Count > 0)
                    itemstring = item.ContentContainer.contents.Aggregate(itemstring, (current, mod) => current + $"_{mod.ShortName}");
        ...
        {
            if (!userId.IsSteamId() || string.IsNullOrEmpty(name) || amount < 0) return;

            var playerData = PlayerData.GetOrCreateKitData(userId.ToString(), name);
            if (playerData == null) return;

            playerData.Cooldown = GetCurrentTime() + amount;
        }
        ...
        public object GiveKit(BasePlayer player, string name)
        {
            if (FindKitByName(name) == null)
                return $"Kit '{name}' doesn't exist";
            return GiveKitToPlayer(player, FindKitByName(name), true, usingUI: false);
        }

        public bool GiveKit(BasePlayer player, string name, bool usingUI)
        {
#if TESTING
        ...
        public bool IsKit(string name)
        {
            return !string.IsNullOrEmpty(name) && _data?.Kits != null && _data.Kits.Exists(x => x.Name == name);
        }
        ...
        internal void OldKitsConvert(ConsoleSystem.Arg arg)
        {
            ...
            {
                PrintError("Could not read the old kits data file, please check if it exists and is not corrupted");
                PrintWarning($"Technical details: {e.Message}");
                return;
            }

            if (oldKits == null)
            {
                PrintError("The old kits data file was found but appears to be empty or invalid");
                return;
            }

            if (oldKits._kits == null || oldKits._kits.Count == 0)
            {
                PrintError("The old kits file contains no kits to convert");
                return;
            }

            var amount = 0;

            foreach (var oldKit in oldKits._kits)
            {
                Kit kit = null;
                try
                {
                    ...
                    {
                        ID = ++_lastKitID,
                        Name = oldKit.Value.Name ?? string.Empty,
                        DisplayName = oldKit.Value.Name ?? string.Empty,
                        Permission = oldKit.Value.RequiredPermission ?? string.Empty,
                        Amount = oldKit.Value.MaximumUses,
                        Cooldown = oldKit.Value.Cooldown,
                        Description = oldKit.Value.Description ?? string.Empty,
                        Hide = oldKit.Value.IsHidden,
                        Building = oldKit.Value.CopyPasteFile ?? string.Empty,
                        Image = oldKit.Value.KitImage ?? string.Empty,
                        Color = _config.KitColor ?? string.Empty,
                        ShowInfo = true,
                        Items = new List<KitItem>()
                    };
                    ...
                    foreach (var item in oldKit.Value.MainItems)
                    {
                        ...
                        kit.Items.Add(FromOldItem(item, "main"));
                    }

                    foreach (var item in oldKit.Value.WearItems)
                    {
                        if (item == null) continue;
                        kit.Items.Add(FromOldItem(item, "wear"));
                    }

                    foreach (var item in oldKit.Value.BeltItems)
                    {
                        if (item == null) continue;
                        kit.Items.Add(FromOldItem(item, "belt"));
                    }
                }
                catch (Exception e)
                {
                    var kitName = oldKit.Value.Name ?? "Unknown Kit";
                    PrintWarning($"Failed to convert kit '{kitName}' due to invalid data structure");
                    PrintWarning($"Technical details: {e.Message}");
                    continue;
                }
        ...
        private static KitItem FromOldItem(ItemData item, string container)
        {
            ...
            var newItem = new KitItem
            {
                ...
                SkinID = item.Skin,
                Blueprint = Convert.ToInt32(item.Shortname?.Contains("blueprintbase") ?? false),
                Condition = item.Condition,
                Position = item.Position,
            ...
            {
                newItem.Content = new List<ItemContent>();
                foreach (var content in item.Contents)
                {
                    newItem.Content.Add(new ItemContent
                    {
                        ShortName = content.Shortname ?? string.Empty,
                        Condition = Math.Clamp(content.Condition, 0f, 100f),
                        Amount = Math.Max(1, content.Amount),
                        Skin = Math.Max(0, content.Skin)
                    });
                }
            }
            ...
            if (item.Ammo > 0)
            {
                ...
                {
                    ammoType = item.Ammotype ?? string.Empty,
                    ammoAmount = Math.Max(0, item.Ammo)
                };
            }

            if (item.Container != null)
            {
                var convertedContainer = ConvertOldContentContainer(item.Container);
                if (convertedContainer != null)
                    newItem.ContentContainer = convertedContainer;
            }

            return newItem;
        }

        private static ContentContainer ConvertOldContentContainer(ItemData.ItemContainer container)
        {
            ...
            var contentContainer = new ContentContainer
            {
                ...
                temperature = container.temperature,
                allowedContents = container.allowedContents,
            ...
            if (container.allowedItems?.Count > 0)
            {
                contentContainer.allowedItems = new List<int>();
                foreach (var allowedItem in container.allowedItems)
                {
                    contentContainer.allowedItems.Add(allowedItem);
                }
            }

            if (container.availableSlots?.Count > 0)
            {
                contentContainer.availableSlots = new List<int>();
                foreach (var slot in container.availableSlots)
                {
                    contentContainer.availableSlots.Add(slot);
                }
            }

            if (container.contents?.Count > 0)
            {
                foreach (var contentItem in container.contents)
                {
                    var convertedItem = FromOldItem(contentItem, "contents");
                    if (convertedItem != null)
                        contentContainer.contents.Add(convertedItem);
                }
            }
