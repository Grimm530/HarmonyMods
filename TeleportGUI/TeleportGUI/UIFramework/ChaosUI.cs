...
public class ChaosUI
{
	...
	public static void Show(BasePlayer player, BaseContainer baseContainer, bool recycle = true)
	{
		...
		// Clients only forward ConsoleGen commands; bridge teleportgui.callback through cui.endtest TELEPORTGUI.
		arg = arg.Replace("\"command\":\"teleportgui.callback ", "\"command\":\"cui.endtest TELEPORTGUI teleportgui.callback ");
		arg = arg.Replace("\"command\": \"teleportgui.callback ", "\"command\": \"cui.endtest TELEPORTGUI teleportgui.callback ");
