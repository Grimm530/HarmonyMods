...
{
    /// <summary>Builds CUI JSON for the Teleport GUI (panel, tabs, list, buttons). Harmony-only/Chaos.</summary>
    public static class TeleportGUIUI
    {
        ...
        public static void Show(BasePlayer player, string json)
        {
            ...
            // Clients only forward ConsoleGen (cui.endtest); rewrite teleportgui.cui → cui.endtest TELEPORTGUI …
            json = GrimmCui.ApplyRewrites(json);
