...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        public static bool AddUi(BasePlayer player, string json)
        {
            if (player?.net != null)
            {
                // Clients only forward ConsoleGen commands. Rewrite Hud CUI button commands
                // to cui.endtest HUD … so Patches.Cui_Endtest_Patch can route them.
        ...
        /// never leave the client. Bridge Hud commands through cui.endtest HUD.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            ...
            var cmds = HudHarmony.HudMod.Instance?.UiConsoleCommands;
            ...
            for (int i = 0; i < cmds.Count; i++)
            {
                ...
                string bridgeArgs = "\"command\":\"cui.endtest HUD " + cmd + " ";
                string bridgeAlone = "\"command\":\"cui.endtest HUD " + cmd + "\"";
