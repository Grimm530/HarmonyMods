    ...
    public class ExtConfig {
        ...
        public sealed class GeneratorSettings {
           ...
           // [JsonProperty(EN ? "Reduce River Width" : "Уменишить ширину рек")]
            ...
            [JsonProperty(EN ? "Remove powerlines" : "Удалить линии электропередач")]
            public bool RemovePowerlines = true;
            [JsonProperty(EN ? "Remove ziplines" : "Удалить зиплайны")]
            public bool RemoveZiplines = true;
            [JsonProperty(EN ? "Blocked Prefabs" : "Заблокированные префабы")]
            public List<string> BlockedPrefabs = new List<string> { "coastal_rocks", "rock_formation_small", "rock_formation_medium" };

            [JsonProperty(EN ? "Block Bandit Camp" : "Заблокировать лагерь бандитов")]
            public bool BlockBanditCamp = false;
            [JsonProperty(EN ? "Force Outpost to map center" : "Принудительно разместить аутпост в центре карты")]
            public bool ForceOutpostToCenter = false;
