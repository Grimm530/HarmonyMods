// Legacy -> Harmony compatibility shims for the ported ArmoredTrain plugin.
...
namespace Harmony.Core
{
    ...
    public class HarmonyModRuntime
    {
        ...
        /// <summary>
        /// compat-style data root. Plugin paths like ArmoredTrain/Images resolve under HarmonyData/.
        /// </summary>
        ...
        {
            Debug.LogWarning("[ArmoredTrain] UnloadPlugin('" + name + "') requested but ignored (Harmony port keeps running / soft-fail).");
        }
    ...
    public class DataFileSystem
    {
        ...
        public T ReadObject<T>(string name)
        {
            ...
            {
                Debug.LogWarning("[ArmoredTrain] DataFileSystem.ReadObject('" + name + "') failed: " + ex.Message);
                return default;
            }
        }
        ...
        public void WriteObject<T>(string name, T obj, bool sync = false)
        {
            ...
            {
                Debug.LogWarning("[ArmoredTrain] DataFileSystem.WriteObject('" + name + "') failed: " + ex.Message);
            }
        }
    }
}
...
namespace Harmony.Plugins
{
    ...
    public class DynamicConfigFile
    {
        ...
        public void WriteObject<T>(T obj, bool sync = false)
        {
            ...
            {
                Debug.LogWarning("[ArmoredTrain] Config write failed: " + ex.Message);
            }
        }
    }
    ...
    public class ServerShim
    {
        public void Command(string command, params object[] args)
        {
            ...
            catch (Exception ex) { Debug.LogWarning("[ArmoredTrain] Server.Command failed: " + ex.Message); }
        }
    ...
    public abstract class RustPlugin
    {
        ...
        // Invoked by ArmoredTrainMod to drive the compat-style lifecycle.
        public void HarmonyLoadConfig() => LoadConfig();
        public void HarmonyLoadDefaultMessages() => LoadDefaultMessages();

        // ----- logging / chat -----
        public void Puts(string format, params object[] args) => Debug.Log("[" + (Title ?? "ArmoredTrain") + "] " + Fmt(format, args));
        public void PrintWarning(string format, params object[] args) => Debug.LogWarning("[" + (Title ?? "ArmoredTrain") + "] " + Fmt(format, args));
        public void PrintError(string format, params object[] args) => Debug.LogError("[" + (Title ?? "ArmoredTrain") + "] " + Fmt(format, args));
        ...
        public void NextTick(Action action)
        {
            ...
            global::ArmoredTrain.ModRunner.Enqueue(action);
        }
