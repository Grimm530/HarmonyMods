...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        /// <summary>
        /// ZoneManager CUI buttons use zmui.editflag. Clients only forward ConsoleGen commands.
        /// Bridge through cui.endtest with ZONEMANAGER marker.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            if (string.IsNullOrEmpty(json) || json.IndexOf("zmui.editflag", StringComparison.Ordinal) < 0)
                return json;
            json = json.Replace("\"command\":\"zmui.editflag", "\"command\":\"cui.endtest ZONEMANAGER zmui.editflag");
            return json;
        }
