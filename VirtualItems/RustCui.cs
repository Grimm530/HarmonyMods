...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        public static bool AddUi(BasePlayer player, string json)
        {
            if (player?.net != null)
            {
                // Clients only forward ConsoleGen commands. Rewrite VirtualItems CUI button commands
                // to cui.endtest VIRTUALITEMS … so Patches.Cui_Endtest_Patch can route them.
        ...
        /// never leave the client. Bridge VirtualItems commands through cui.endtest ST.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            ...
            var cmds = VirtualItemsHarmony.VirtualItemsMod.Instance?.UiConsoleCommands;
            ...
            for (int i = 0; i < cmds.Count; i++)
            {
                ...
                string bridgeArgs = "\"command\":\"cui.endtest VIRTUALITEMS " + cmd + " ";
                string bridgeAlone = "\"command\":\"cui.endtest VIRTUALITEMS " + cmd + "\"";
