...
{
    public partial class VirtualItems
    {
        internal static VirtualItems Instance { get; private set; }
        internal static void SetInstance(VirtualItems inst) => Instance = inst;
        internal static void ClearInstance() => Instance = null;
        internal static VirtualItems GetModInstance() => Instance;
        ...
        public void CallInit()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[VirtualItems] Init failed: " + ex.Message); }
            try { HarmonyLoadDefaultMessages(); }
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[VirtualItems] LoadDefaultMessages failed: " + ex.Message); }
        }
        ...
        public void CallLoaded()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[VirtualItems] Loaded failed: " + ex.Message); }
        }
        ...
        public void CallOnServerInitialized()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogError("[VirtualItems] OnServerInitialized failed: " + ex); }
        }
        ...
        public void CallUnload()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[VirtualItems] Unload failed: " + ex.Message); }
        }
        ...
        static System.Reflection.MethodInfo FindHook(VirtualItems inst, string hook, object[] args)
        {
        ...
        static T CallHook<T>(string hook, params object[] args)
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[VirtualItems] " + hook + ": " + (ex.InnerException ?? ex).Message); }
            return default;
        }
        ...
        static object CallHookObj(string hook, params object[] args)
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[VirtualItems] " + hook + ": " + (ex.InnerException ?? ex).Message); return null; }
        }
