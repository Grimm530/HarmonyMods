# Build script for RustEditStandalone Harmony Mod
# Output: D:\!RustServer\HarmonyMods\RustEditStandalone.dll
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "The mod will load automatically on next server start (harmony.load RustEditStandalone)." -ForegroundColor Yellow
} else {
