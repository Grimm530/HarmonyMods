...
public class ChaosUI
{
	...
	public static void Show(BasePlayer player, BaseContainer baseContainer, bool recycle = true)
	{
		...
		// Clients only forward ConsoleGen commands; bridge adminmenu.callback through cui.endtest ADMINMENU.
		arg = arg.Replace("\"command\":\"adminmenu.callback ", "\"command\":\"cui.endtest ADMINMENU adminmenu.callback ");
		arg = arg.Replace("\"command\": \"adminmenu.callback ", "\"command\": \"cui.endtest ADMINMENU adminmenu.callback ");
