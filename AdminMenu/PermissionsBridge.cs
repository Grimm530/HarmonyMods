...
namespace AdminMenuHarmony
{
    ...
    public static class PermissionsBridge
    {
        ...
        public static void RegisterReadyCallback(Action callback)
        {
            ...
            {
                Debug.LogWarning("[AdminMenu] RegisterReadyCallback: " + ex.Message);
            }
            ...
            {
                Debug.LogWarning("[AdminMenu] RegisterReadyCallback fallback: " + ex.Message);
            }
        }
        ...
        private static void EnsureBound()
        {
            ...
            try
            {
                ...
                {
                    _loggedLink = true;
                    Debug.Log("[AdminMenu] Linked to Permissions Harmony mod.");
                }
                else
                    Debug.Log($"[AdminMenu] Re-linked to Permissions Harmony mod (gen={gen}).");
            }
            catch (Exception ex)
            {
                ClearBind();
                Debug.LogWarning("[AdminMenu] Permissions bind failed: " + ex.Message);
            }
        }
        ...
        private static void BindService()
        {
            ...
            {
                Debug.LogWarning("[AdminMenu] Permissions Service bind: " + ex.Message);
            }
        }
