...
namespace Oxide.Plugins
{
    ...
    public partial class UberTool : RustPlugin
    {
        [PluginReference]
        ...
        public class EPlanner : MonoBehaviour
        {
            ...
            private void Rycst(PlayerTick tick)
            {
                ...
                int layer = sRmvr && Instance.removeToolObjects ? 1143155457 : 2163457; // Default, Deployed, Ragdoll, AI, Vehicle Detailed, World, Player (Server), Construction, Bush, Tree | Default, Deployed, Ragdoll, World, Construction
                float range = 24f;
                ...
                if (Physics.Raycast(lastRay, out rayHit, range, layer, QueryTriggerInteraction.Ignore))
                {
                    ...
                    if (ent != null && ent != rayEntity && !isParented)
                    {
                        ...
                        rayEntityName = "";
                        if (rayDefinition) 
                            rayEntityName = rayDefinition.info.name.english;
                        ...
                        if (rayEntityName.Length == 0)
                        {
                            if (rayEntity is BaseCombatEntity combat)
                            {
                                ...
                                rayEntityName = target ? (target.displayName.english) : string.Empty;
            ...
            private void Hldtm()
            {
                ...
                else if (heldItem is Chainsaw && (serverInput.WasJustPressed((BTN)8192) || serverInput.IsDown((BTN)1024) || serverInput.WasJustPressed((BTN)2048)))
                {
                    ...
                    {
                        saw.SetEngineStatus(true, BaseEntity.FlagsUpdateMode.SendNetworkUpdateImmediate);
                    }
                        ...
                        else if (serverInput.WasJustPressed(controlButtons[CmdType.HammerRotate]))
                        {
                            ...
                            if (rayEntity is StabilityEntity)
                            {
                                ...
                                if (rayEntity is BuildingBlock)
                                {
                                    ...
                                    rayEntity.ClientRPC(RpcTarget.NetworkGroup(r("ErserfuFxva")));
                                }
                            }
        ...
        {
            new ("assets/prefabs/building core/wall.low/wall.low.prefab", "assets/prefabs/building core/wall.low/wall.third.png"),
            new ("assets/prefabs/building core/stairs.u/block.stair.ushape.prefab", "assets/prefabs/building core/stairs.u/stairs_u.png"),
            new ("assets/prefabs/building core/stairs.l/block.stair.lshape.prefab", "assets/prefabs/building core/stairs.l/stairs_l.png"),
            new ("assets/prefabs/building core/stairs.spiral/block.stair.spiral.prefab", "assets/prefabs/building core/stairs.spiral/stairs_spiral.png"),
            new ("assets/prefabs/building core/stairs.spiral.triangle/block.stair.spiral.triangle.prefab", "assets/prefabs/building core/stairs.spiral.triangle/stairs.triangle.spiral.png"),
            new ("assets/prefabs/building core/roof.triangle/roof.triangle.prefab", "assets/prefabs/building core/roof.triangle/roof.triangle.png"),
            new ("assets/prefabs/building core/roof/roof.prefab", "assets/prefabs/building core/roof/roof.png"),
            new ("assets/prefabs/building core/foundation/foundation.prefab", "assets/prefabs/building core/foundation/foundation.png"),
            new ("assets/prefabs/building core/foundation.triangle/foundation.triangle.prefab", "assets/prefabs/building core/foundation.triangle/foundation.triangle.png"),
            new ("assets/prefabs/building core/foundation.steps/foundation.steps.prefab", "assets/prefabs/building core/foundation.steps/foundation.steps.png"),
            new ("assets/prefabs/building core/ramp/ramp.prefab", "assets/prefabs/building core/ramp/ramp.png"),
            new ("assets/prefabs/building core/floor/floor.prefab", "assets/prefabs/building core/floor/floor.png"),
            new ("assets/prefabs/building core/floor.triangle/floor.triangle.prefab", "assets/prefabs/building core/floor.triangle/floor.triangle.png"),
            new ("assets/prefabs/building core/floor.frame/floor.frame.prefab", "assets/prefabs/building core/floor.frame/floor.frame.png"),
            new ("assets/prefabs/building core/floor.triangle.frame/floor.triangle.frame.prefab", "assets/prefabs/building core/floor.triangle.frame/floor.triangle.frame.png"),
            new ("assets/prefabs/building core/wall/wall.prefab", "assets/prefabs/building core/wall/wall.png"),
            new ("assets/prefabs/building core/wall.doorway/wall.doorway.prefab", "assets/prefabs/building core/wall.doorway/wall.doorway.png"),
            new ("assets/prefabs/building core/wall.window/wall.window.prefab", "assets/prefabs/building core/wall.window/wall.window.png"),
            new ("assets/prefabs/building core/wall.frame/wall.frame.prefab", "assets/prefabs/building core/wall.frame/wall.frame.png"),
            new ("assets/prefabs/building core/wall.half/wall.half.prefab", "assets/prefabs/building core/wall.half/wall.half.png"),
        };
        ...
        private class ConstructionInfo
        {
            ...
            public ConstructionInfo(string prefabPath, string icon)
            {
            ...
            public void FindPrefabId()
            {
                ...
                {
                    if (s.Equals(PrefabPath, StringComparison.OrdinalIgnoreCase))
                    {
                        prefabPath = s;
                        break;
                    }
                ...
                {
                    Debug.LogError($"[UberTool] Failed to find prefab ID for {PrefabPath}");
                    return;
                }
        ...
        private void cmdPrefab(ConsoleSystem.Arg arg)
        {
            ...
            int.TryParse(arg.GetString(0), out int id);
            if (id < 0) return;
            if (id == 6666)
            {
                TgglTls(player);
        ...
        private void cmdScale(ConsoleSystem.Arg arg)
        {
            ...
            {
                float.TryParse(arg.GetString(0), out f);
                if (f == 0f) return;
            }
            else
            {
                float.TryParse(arg.GetString(0), out float w);
                if (w <= 0f) return;
                float.TryParse(arg.GetString(1), out float h);
                if (h <= 0f) return;
                f = w / h;
            }
