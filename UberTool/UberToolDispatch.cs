...
{
    public partial class UberTool
    {
        internal static void SetInstance(UberTool inst) => Instance = inst;
        internal static void ClearInstance() => Instance = null;
        internal static UberTool GetModInstance() => Instance;
        ...
        public void CallInit()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[UberTool] Init failed: " + ex.Message); }
            try { HarmonyLoadDefaultMessages(); }
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[UberTool] LoadDefaultMessages failed: " + ex.Message); }
        }
        ...
        public void CallLoaded()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[UberTool] Loaded failed: " + ex.Message); }
        }
        ...
        public void CallOnServerInitialized()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogError("[UberTool] OnServerInitialized failed: " + ex); }
        }
        ...
        public void CallUnload()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[UberTool] Unload failed: " + ex.Message); }
        }
        ...
        static System.Reflection.MethodInfo FindHook(UberTool inst, string hook, object[] args)
        {
        ...
        static T CallHook<T>(string hook, params object[] args)
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[UberTool] " + hook + ": " + (ex.InnerException ?? ex).Message); }
            return default;
        }
        ...
        static object CallHookObj(string hook, params object[] args)
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[UberTool] " + hook + ": " + (ex.InnerException ?? ex).Message); return null; }
        }
