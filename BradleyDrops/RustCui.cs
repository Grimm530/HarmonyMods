...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        public static bool AddUi(BasePlayer player, string json)
        {
            if (player?.net != null)
            {
                // Clients only forward ConsoleGen commands. Rewrite BradleyDrops CUI button commands
                // to cui.endtest BRADLEYDROPS … so Patches.Cui_Endtest_Patch can route them.
        ...
        private static string RewriteHarmonyButtonCommands(string json)
        {
            ...
            var cmds = BradleyDropsHarmony.BradleyDropsMod.Instance?.UiConsoleCommands;
            ...
            for (int i = 0; i < cmds.Count; i++)
            {
                ...
                string bridgeArgs = "\"command\":\"cui.endtest BRADLEYDROPS " + cmd + " ";
                string bridgeAlone = "\"command\":\"cui.endtest BRADLEYDROPS " + cmd + "\"";
