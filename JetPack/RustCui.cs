...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        public static bool AddUi(BasePlayer player, string json)
        {
            if (player?.net != null)
            {
                // Clients only forward ConsoleGen commands. Rewrite JetPack CUI button commands
                // to cui.endtest JETPACK … so Patches.Cui_Endtest_Patch can route them.
        ...
        /// never leave the client. Bridge JetPack commands through cui.endtest ST.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            ...
            var cmds = JetPackHarmony.JetPackMod.Instance?.UiConsoleCommands;
            ...
            for (int i = 0; i < cmds.Count; i++)
            {
                ...
                string bridgeArgs = "\"command\":\"cui.endtest JETPACK " + cmd + " ";
                string bridgeAlone = "\"command\":\"cui.endtest JETPACK " + cmd + "\"";
