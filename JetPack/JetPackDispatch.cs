...
{
    public partial class JetPack
    {
        internal static void SetInstance(JetPack inst) => _ins = inst;
        internal static void ClearInstance() => _ins = null;
        internal static JetPack GetModInstance() => _ins;
        ...
        public void CallInit()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[JetPack] Init failed: " + ex.Message); }
            try { HarmonyLoadDefaultMessages(); }
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[JetPack] LoadDefaultMessages failed: " + ex.Message); }
        }
        ...
        public void CallLoaded()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[JetPack] Loaded failed: " + ex.Message); }
        }
        ...
        public void CallOnServerInitialized()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogError("[JetPack] OnServerInitialized failed: " + ex); }
        }
        ...
        public void CallUnload()
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[JetPack] Unload failed: " + ex.Message); }
        }
        ...
        static T CallHook<T>(string hook, params object[] args)
        {
            ...
            try
            {
                ...
                foreach (var mi in inst.GetType().GetMethods(bf))
                {
                    ...
                    if (!ArgsCompatible(mi.GetParameters(), args)) continue;
                    var r = mi.Invoke(inst, args);
                    if (r is T t) return t;
                    return default;
                }
            }
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[JetPack] " + hook + ": " + (ex.InnerException ?? ex).Message); }
            return default;
        }
        ...
        static object CallHookObj(string hook, params object[] args)
        {
            ...
            catch (Exception ex) { UnityEngine.Debug.LogWarning("[JetPack] " + hook + ": " + (ex.InnerException ?? ex).Message); return null; }
            return null;
        }
        ...
        public static void Dispatch_OnEntitySpawned(SupplyDrop drop)
            => CallHookVoid("OnEntitySpawned", drop);
