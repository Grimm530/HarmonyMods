...
#pragma warning restore CS0414
        ...
        public const bool LangRu = false;
...
#else
                return DateTime.UtcNow.AddHours(Instance?._config?.TimeZone ?? 0);
#endif
            }
        }
        ...
        private Configuration _config = Configuration.GetDefaultConfig();
        ...
        {
            _config = Configuration.GetDefaultConfig();
        }
        ...
        public class Configuration
        {
            ...
            [JsonProperty(LangRu
                ? "Начинать календарную неделю с воскресенья"
                : "Start calendar week on Sunday")]
            public bool WeekStartsOnSunday = false;
        ...
        private const string
            UI_Date = "UI_Date",
            UI_Time = "UI_Time",
            UI_Repeat_Every = "UI_Repeat_Every",
            UI_Color_Picker = "UI_Color_Picker",
            UI_Color_Selected = "UI_Color_Selected",
            UI_Color_Hex = "UI_Color_Hex",
            UI_Color_Alpha = "UI_Color_Alpha",
            UI_Days = "UI_Days",
            UI_Weeks = "UI_Weeks",
            UI_Repeat_On = "UI_Repeat_On",
            UI_Apply_For_Everyone = "UI_Apply_For_Everyone",
            UI_Month = "UI_Month",
            UI_Years = "UI_Years",
            UI_BTN_Back = "UI_BTN_Back",
            UI_BTN_Next = "UI_BTN_Next",
            UI_BTN_Close = "UI_BTN_Close",
            UI_Msg_WhatYouGot_Every = "UI_Msg_WhatYouGot_Every",
            UI_Msg_OfEvery = "UI_Msg_OfEvery",
            UI_BTN_Down = "UI_BTN_Down",
            UI_BTN_Up = "UI_BTN_Up",
            UI_Input_Default = "UI_Input_Default",
            Calendar = "Calendar",
        ...
        protected override void LoadDefaultMessages()
        {
            var ru = new Dictionary<string, string>
            {
                ...
                [TypeEvent.Today.ToString()] = "Сегодня",
                ...
                [UI_Date] = "ДАТА",
                [UI_Time] = "ВРЕМЯ",
                [UI_Repeat_Every] = "ПОВТОРЯТЬ КАЖДЫЙ",
                [UI_Color_Picker] = "ВЫБОР ЦВЕТА",
                [UI_Color_Selected] = "ВЫБРАННЫЙ ЦВЕТ:",
                [UI_Color_Hex] = "HEX",
                [UI_Color_Alpha] = "ПРОЗРАЧНОСТЬ (0-100)",
                [UI_Days] = "ДНИ",
                [UI_Weeks] = "НЕДЕЛИ",
                [UI_Repeat_On] = "ПОВТОРЯТЬ НА",
                [UI_Apply_For_Everyone] = "ПРИМЕНИТЬ ДЛЯ ВСЕХ СОБЫТИЙ ЭТОГО ТИПА",
                [UI_Month] = "месяц",
                [UI_Years] = "годы",
                [UI_BTN_Back] = "<",
                [UI_BTN_Next] = ">",
                [UI_BTN_Close] = "X",
                [UI_Msg_WhatYouGot_Every] = "Что вы получили: Повторять каждый {0}й день.",
                [UI_Msg_OfEvery] = "{0} каждый",
                [UI_BTN_Down] = "▼",
                [UI_BTN_Up] = "▲",
                [UI_Input_Default] = "по умолчанию",
                [TimeZoneSuffix] = " UTC {0}",
            };
            ...
            var en = new Dictionary<string, string>
            {
                ...
                [TypeEvent.Today.ToString()] = "Today",
                ...
                [UI_Date] = "DATE",
                [UI_Time] = "TIME",
                [UI_Repeat_Every] = "REPEAT EVERY",
                [UI_Color_Picker] = "COLOR PICKER",
                [UI_Color_Selected] = "Selected color:",
                [UI_Color_Hex] = "HEX",
                [UI_Color_Alpha] = "Opacity (0-100)",
                [UI_Days] = "DAYS",
                [UI_Weeks] = "WEEKS",
                [UI_Repeat_On] = "REPEAT ON",
                [UI_Apply_For_Everyone] = "APPLY AN ICON FOR EVERYONE EVENTS OF THIS TYPE",
                [UI_Month] = "month",
                [UI_Years] = "years",
                [UI_BTN_Back] = "<",
                [UI_BTN_Next] = ">",
                [UI_BTN_Close] = "X",
                [UI_Msg_WhatYouGot_Every] = "What you got: Repeat every {0}th day.",
                [UI_Msg_OfEvery] = "{0} of every",
                [UI_BTN_Down] = "▼",
                [UI_BTN_Up] = "▲",
                [UI_Input_Default] = "default",
                [TimeZoneSuffix] = " UTC {0}",
            };

            foreach (var custom in _config.GetCustomLang())
        ...
        private void LoadColors()
        {
            ...
            if (Version == new VersionNumber(2, 0, 9))
                if (EventsColors.TryAdd(TypeEvent.Today, new IColor("#00E6FF", 20)))
                {
                    SaveDateFile(FILE_EventsColors, EventsColors);
                }
#endif
        }
 ...
 new CustomDateTime(ModeRepeat.Weeks, 1, 1, new bool[7]{ false, false,  false,  false,  false,  true,  false },
        ...
        private class ScheduleToDay
        {
            ...
            public void SetScheduleOfMonth(DateTime startDate, List<ScheduleToDay> list)
            {
                ...
                switch (CustomDateTimeEvent.Mode)
                {
                    ...
                    {
                        if (CustomDateTimeEvent.DaysInterval < 1) return;

                        for (var day = 1; day <= daysInMonth; day++)
                        {
                            var targetDate = new DateTime(startDate.Year, startDate.Month, day, CustomDateTimeEvent.Times.Hour, CustomDateTimeEvent.Times.Minute, 0);
                                    
                            if (targetDate < DateTimeEvent) continue;

                            var daysFromStart = targetDate.Subtract(DateTimeEvent).TotalDays;
                            if (daysFromStart % CustomDateTimeEvent.DaysInterval != 0) continue;
        ...
        private class UserInterfaceSetup
        {
            ...
            public class PanelCalendarUI
            {
                ...
                public class PanelScheduleUI
                {
                    ...
                    {
                        [JsonProperty(LangRu ? "Показать панель с командой /info и цветовыми маркерами событий?" : "Show panel with /info command and event color markers?")]
                        public bool ShowScheduleInfoPanel = true;
...
#if !SCHEDULE_DEBUG
        internal void AddEventManagerSchedule(List<(string, string, int hour, int minutes, bool[])> scheduleGlobalEvents)
        {
        ...
        internal void CmdWipeSchedule(IPlayer cov, string command, string[] args)
        {
        ...
        internal CuiElementContainer API_OpenPlugin(BasePlayer player)
        {
            return PlayerUIController.GetContainer(player, PlayerUIController.TypeUI.ServerMenu);
        }

        internal void CmdConsoleWipeSchedule(ConsoleSystem.Arg arg)
        {
            var player = arg.Player();
            if (player == null || !arg.HasArgs()) return;

            PlayerUIController.OnClickButton(player, arg.ToStringArray());
        }

        internal void CmdCheckTime(ConsoleSystem.Arg arg)
        {
            if (!arg.IsServerside) return;

            var utcNow = DateTime.UtcNow;
            var configuredTime = currentDateTime;
            
            SendReply(arg, $"=== Wipe Schedule Time Check ===\n" +
                          $"UTC Time: {utcNow:yyyy-MM-dd HH:mm:ss}\n" +
                          $"Configured TimeZone: {_config.TimeZone:+#;-#;0} hours\n" +
                          $"Plugin Time: {configuredTime:yyyy-MM-dd HH:mm:ss}\n" +
                          $"Current Day: {configuredTime.Day}, Month: {configuredTime.Month}, Year: {configuredTime.Year}");
        }
        ...
        {
            AddCovalenceCommand(_config.Commands, nameof(CmdWipeSchedule));
        }
        ...
        private readonly Dictionary<string, string> _loadedImages = new Dictionary<string, string>();
        ...
        internal bool AddImage(string url, string fileName, ulong id = 0)
        {
            ...
            if (_loadedImages.ContainsKey(fileName)) return true;
            LoadImageFromUrl(fileName, url);
            return true;
        }
        ...
        internal void LoadImages()
        {
            ...
            if (ServerPanel is not {IsLoaded: true})
            {
            ...
            timer.In(1f, () =>
            {
                // Harmony: no ImageLibrary — load HTTP images into FileStorage ourselves.
                foreach (var kv in imagesList)
                {
                    if (string.IsNullOrEmpty(kv.Value)) continue;
                    LoadImageFromUrl(kv.Key, kv.Value);
                }
                Puts($"Built-in image loader active ({imagesList.Count} images queued)");
            });
        }
        ...
        private void LoadImageFromUrl(string name, string url)
        {
            ...
            if (_loadedImages.ContainsKey(name)) return;
            ServerMgr.Instance?.StartCoroutine(LoadImageHttp(name, url));
        }
        ...
        private IEnumerator LoadImageHttp(string name, string url)
        {
            ...
            {
                PrintWarning($"Image download failed: {url} ({www.error})");
                yield break;
            }
        ...
        private class AdminUIController : PlayerUIController
        {
                    ...
                    Components =
                    {
                        new CuiTextComponent
                        {
                            Text = targetSchedule.ScheduleType == TypeSchedule.CustomDate
                                ? targetSchedule.CustomDateTimeEvent.Times.ToStringTime_HM(GetTimeZoneSuffix())
                                : targetSchedule.DateTimeEvent.ToStringDateTime_DMYHM(GetTimeZoneSuffix()),
                            Align = TextAnchor.MiddleLeft,
                            Font = "robotocondensed-bold.ttf",
                            FontSize = 14,
                        ...
                        if (selectedSchedule != null)
                        {
                            ...
                            OwnerContainer.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiTextComponent
                                    {
                                        Text = GetMessage(UI_Date, owner.UserIDString), Font = "robotocondensed-bold.ttf", FontSize = 10,
                            ...
                            OwnerContainer.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiTextComponent
                                    {
                                        Text = GetMessage(UI_Time, owner.UserIDString), Font = "robotocondensed-bold.ttf", FontSize = 10,
                                        Align = TextAnchor.UpperLeft, Color = HexToCuiColor("#E2DBD3", 90)
                                    },
                                    new CuiRectTransformComponent
                            ...
                            OwnerContainer.Add(new CuiElement
                            {
                                ...
                                Components =
                                {
                                    new CuiTextComponent
                                    {
                                        Text = GetMessage(UI_Repeat_Every, owner.UserIDString), Font = "robotocondensed-bold.ttf", FontSize = 10,
                                        Align = TextAnchor.UpperLeft, Color = HexToCuiColor("#E2DBD3", 90)
                                    },
                                    new CuiRectTransformComponent
            ...
            private void AddColorSelectionPanel()
            {
                ...
                }, "OverlayNonScaled", LayerGeneral + ".color.selector", LayerGeneral + ".color.selector");
                ...
                OwnerContainer.Add(new CuiLabel
                {
                    ...
                    Text =
                    {
                        Text = GetMessage(UI_Color_Picker, owner.UserIDString),
                        Align = TextAnchor.MiddleLeft,
                        Font = "robotocondensed-bold.ttf",
                        FontSize = 22,
                ...
                OwnerContainer.Add(new CuiButton
                {
                    ...
                    Text =
                    {
                        Text =  GetMessage(UI_BTN_Close, owner.UserIDString),
                        Align = TextAnchor.MiddleCenter,
                        Font = "robotocondensed-bold.ttf",
                        FontSize = 22,
                ...
                if (selectedColor != null)
                {
                    ...
                    OwnerContainer.Add(new CuiLabel
                    {
                        ...
                        Text =
                        {
                            Text = GetMessage(UI_Color_Selected, owner.UserIDString),
                            Align = TextAnchor.UpperLeft,
                            Font = "robotocondensed-regular.ttf",
                            FontSize = 14,
                            Color = "1 1 1 1"
                    ...
                    OwnerContainer.Add(new CuiLabel
                    {
                        ...
                        Text =
                        {
                            Text = GetMessage(UI_Color_Hex, owner.UserIDString),
                            Align = TextAnchor.UpperLeft,
                            Font = "robotocondensed-regular.ttf",
                            FontSize = 12,
                    ...
                    OwnerContainer.Add(new CuiLabel
                    {
                        ...
                        Text =
                        {
                            Text = GetMessage(UI_Color_Alpha, owner.UserIDString),
                            Align = TextAnchor.UpperLeft,
                            Font = "robotocondensed-regular.ttf",
                            FontSize = 12,
                            Color = HexToCuiColor("#FFFFFF")
                ...
                switch (type)
                {
                    ...
                    case 1: // selector
                    {
                        ...
                        OwnerContainer.Add(new CuiButton
                        {
                            ...
                            Text =
                            {
                                Text = GetMessage(UI_BTN_Next, owner.UserIDString),
                                Align = TextAnchor.MiddleCenter,
                                Color = HexToCuiColor("#E2DBD3", 90),
                                FontSize = 20,
                                Font = "robotocondensed-bold.ttf"
                        ...
                        OwnerContainer.Add(new CuiButton
                        {
                            ...
                            Text =
                            {
                                Text = GetMessage(UI_BTN_Back, owner.UserIDString),
                                Align = TextAnchor.MiddleCenter,
                                Color = HexToCuiColor("#E2DBD3", 90),
                                FontSize = 20,
                                Font = "robotocondensed-bold.ttf"
                    ...
                    case 3: // icon
                    {
                        ...
                        OwnerContainer.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiTextComponent
                                {
                                    Text = GetMessage(UI_Apply_For_Everyone, owner.UserIDString),
                    ...
                    case 3: // icon
                    {
                        ...
                        OwnerContainer.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiInputFieldComponent
                                {
                                    Text = string.IsNullOrEmpty(selectedUrl) ? GetMessage(UI_Input_Default, owner.UserIDString) : selectedUrl,
                                    Align = TextAnchor.MiddleLeft,
                                    Color = HexToCuiColor("#E2DBD3", 50),
                                    FontSize = 12,
                                    Font = "robotocondensed-regular.ttf",
                    ...
                    case ModeRepeat.Days: // day
                    {
                        ...
                        OwnerContainer.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiTextComponent
                                {
                                    Text = GetMessage(UI_Days, owner.UserIDString), Font = "robotocondensed-regular.ttf", FontSize = 12,
                    ...
                    case ModeRepeat.Weeks: // weeks
                    {
                        ...
                        OwnerContainer.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiTextComponent
                                {
                                    Text = GetMessage(UI_Weeks, owner.UserIDString), Font = "robotocondensed-regular.ttf", FontSize = 12,
                                    Align = TextAnchor.MiddleLeft, Color = HexToCuiColor("#E2DBD3", 90)
                                },
                                new CuiRectTransformComponent
                                {
                        ...
                        OwnerContainer.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiTextComponent
                                {
                                    Text = GetMessage(UI_Repeat_On, owner.UserIDString), Font = "robotocondensed-bold.ttf", FontSize = 10,
                                    Align = TextAnchor.UpperLeft, Color = HexToCuiColor("#E2DBD3", 90)
                                },
                                new CuiRectTransformComponent
                                {
                    ...
                    case ModeRepeat.Months: // months
                    {
                        ...
                        OwnerContainer.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiTextComponent
                                {
                                    Text = GetMessage(UI_Msg_OfEvery, owner.UserIDString, $"{inputDay.FormatDayNumberWithSuffix()}"),
                                    Font = "robotocondensed-regular.ttf",
                                    FontSize = 10,
                                    Align = TextAnchor.MiddleLeft,
                                    Color = HexToCuiColor("#E2DBD3", 90)
                        ...
                        OwnerContainer.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiTextComponent
                                {
                                    Text = GetMessage(UI_Month, owner.UserIDString), Font = "robotocondensed-regular.ttf", FontSize = 11,
                                    Align = TextAnchor.MiddleLeft, Color = HexToCuiColor("#E2DBD3", 90)
                                },
                                new CuiRectTransformComponent
                                {
                    ...
                    case ModeRepeat.Years: // years
                    {
                        ...
                        OwnerContainer.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiTextComponent
                                {
                                    Text = GetMessage(UI_Years, owner.UserIDString), Font = "robotocondensed-regular.ttf", FontSize = 11,
                                    Align = TextAnchor.MiddleLeft, Color = HexToCuiColor("#E2DBD3", 90)
                                },
                                new CuiRectTransformComponent
            ...
            private void UpdateRepeatDaysIntervalUI(bool update = false)
            {
                ...
                OwnerContainer.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        new CuiTextComponent
                        {
                            Text = GetMessage(UI_Msg_WhatYouGot_Every, owner.UserIDString, $"{inputInterval:0}"),
                            Font = "robotocondensed-regular.ttf", FontSize = 10,
                            Align = TextAnchor.UpperLeft, Color = HexToCuiColor("#E2DBD3", 90)
                        },
                        new CuiRectTransformComponent
                ...
                OwnerContainer.Add(new CuiButton
                    {
                        Text =
                        {
                            Text = enabledDropdown ? GetMessage(UI_BTN_Down, owner.UserIDString) : GetMessage(UI_BTN_Up, owner.UserIDString), Font = "robotocondensed-regular.ttf", FontSize = 16,
                            ...
                            case ModeRepeat.Days:
                            {
                                switch (args[1])
                                {
                                    case "interval":
                                    {
                                        ...
                                        if (interval <= 0)
                                        {
                                            Instance?.SendNotify(owner, "Interval must be greater than 0", 1);
                                            return;
                                        }
        ...
        private class PlayerUIController
        {
            ...
            public PlayerUIController(BasePlayer player, TypeUI typeUI)
            {
                ...
                switch (Type)
                {
                    case TypeUI.FullScreen:
                    {
                        ...
                        screenInterfaceSetup.AddScreenUI(OwnerContainer, "OverlayNonScaled", Layer, Layer);
            ...
            protected string GetTimeZoneSuffix()
            {
                var offset = Instance._config.TimeZone;
                return GetMessage(TimeZoneSuffix, owner.UserIDString, offset > 0 ? $"+{offset}" : offset.ToString());
            }
            ...
            private void CreateUI()
            {
                ...
                for (var i = 1; i <= 7; i++)
                {
                    var week = Instance._config.WeekStartsOnSunday 
                        ? (i == 1 ? 0 : i - 1)  // Sunday = 0, Monday = 1, ..., Saturday = 6
                        : (i == 7 ? 0 : i);      // Monday = 1, ..., Saturday = 6, Sunday = 0
                ...
                if (setupPanel.PanelCalendar.PanelSchedule.ScheduleInfo.ShowScheduleInfoPanel)
                {
                    OwnerContainer.Add(
                ...
                for (var i = 0; i < scheduleOfSelectedDay.Count; i++)
                {
                    ...
                    OwnerContainer.Add(
                        setupPanel.PanelCalendar.PanelSchedule.PanelShowDay.ScrollPanel.ContentScroll.TimeEvent
                            .CreateText(targetSchedule.DateTimeEvent.ToStringTime_HM(GetTimeZoneSuffix()),
            ...
            protected void AddTableDate()
            {
                ...
                var start = Instance._config.WeekStartsOnSunday
                    ? (_week == DayOfWeek.Sunday ? 0 : -(int)_week)  // Sunday = 0, Monday = -1, ..., Saturday = -6
                    : (_week == DayOfWeek.Sunday ? -6 : 1 - (int)_week);  // Monday = 0, ..., Saturday = -5, Sunday = -6
                for (var i = 0; i < 42; i++)
                {
            ...
            protected bool TryGetColorPriority(DateTime dateTime, out IColor color)
            {
                ...
                {
                    Instance.EventsColors.TryGetValue(TypeEvent.Today, out color);
                    return true;
                }

                var targetDay = scheduleOfSelectedMonth.Find(x => x.HasEventOfDay(dateTime));
                if (targetDay == null)
                    return false;
...
namespace WipeScheduleHarmony.WipeScheduleEx
{
    public static class ExtensionMethods
    {
        ...
        public static string ToStringDateTime_DMYHM(this DateTime dateTime, string timeZoneSuffix = "")
        {
            return
                $"{dateTime.Day:00}.{dateTime.Month:00}.{dateTime.Year:0000} {dateTime.Hour:00}:{dateTime.Minute:00}{timeZoneSuffix}";
        }

        public static string ToStringTime_HM(this DateTime dateTime, string timeZoneSuffix = "")
        {
            return $"{dateTime.Hour:00}:{dateTime.Minute:00}{timeZoneSuffix}";
        }

        public static string ToStringTime_HM(this WipeSchedule.MyTime time, string timeZoneSuffix = "")
        {
            return $"{time.Hour:00}:{time.Minute:00}{timeZoneSuffix}";
        }
