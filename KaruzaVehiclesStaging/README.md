...
**Harmony-only dependency.** Harmony port of Karuza custom-entity vehicles (not vanilla VehicleLicence / Harmony **RustVehicles**).
...
| Oxide | Harmony |
|-------|---------|
| `legacy/config/KaruzaEntitiesCommon.json` | `HarmonyConfig/KaruzaEntitiesCommon.json` |
| `legacy/config/RustCar.json` + `RustCar/` | `HarmonyConfig/RustCar.json` + `HarmonyConfig/RustCar/` |
| `legacy/config/RustHelicopter.json` + dir | `HarmonyConfig/RustHelicopter.json` + `HarmonyConfig/RustHelicopter/` |
| `legacy/config/RustPlane.json` + dir | `HarmonyConfig/RustPlane.json` + `HarmonyConfig/RustPlane/` |
