...
namespace Oxide.Game.Rust.Cui
{
    ...
    public static class CuiHelper
    {
        ...
        public static bool AddUi(BasePlayer player, string json)
        {
            if (player?.net != null)
            {
                // Clients only forward ConsoleGen commands. Rewrite CombatClasses CUI button commands
                // to cui.endtest CC … so Patches.Cui_Endtest_Patch can route them.
        ...
        /// never leave the client. Bridge CombatClasses commands through cui.endtest ST.
        /// </summary>
        private static string RewriteHarmonyButtonCommands(string json)
        {
            ...
            var cmds = CombatClassesHarmony.CombatClassesMod.Instance?.UiConsoleCommands;
            ...
            for (int i = 0; i < cmds.Count; i++)
            {
                ...
                string bridgeArgs = "\"command\":\"cui.endtest CC " + cmd + " ";
                string bridgeAlone = "\"command\":\"cui.endtest CC " + cmd + "\"";
